...
exports.renderCharacterDetailView = renderCharacterDetailView;
...
function renderMeter(value, modifierClassName = "") {
    const meterClassName = modifierClassName.length > 0
...
function renderSkillPips(value, tone) {
...
function renderCharacterDetailView(character, options = {}) {
    const portraitLabel = character.portraitVariants?.find((variant) => variant.id === character.portraitVariantId)?.label ?? "通常";
      ...
      <div class="c-character-detail">
        ...
        .map((skillKey) => `
                    <div class="c-character-detail__skill-row">
                      <span class="c-character-detail__skill-name">${character_1.SKILL_LABELS[skillKey]}</span>
