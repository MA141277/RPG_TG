...
test("main ui flow no longer owns direct script editor change routing", () => {
  ...
  assert.doesNotMatch(mainUiFlowSource, /data-script-editor-event-repeatable/);
  assert.doesNotMatch(mainUiFlowSource, /data-script-editor-event-binding-field/);
  assert.doesNotMatch(mainUiFlowSource, /data-script-editor-minigame-field/);
  assert.doesNotMatch(mainUiFlowSource, /data-script-editor-relation-kind\^="story-related-"/);
  assert.doesNotMatch(mainUiFlowSource, /data-script-editor-person-trade-enabled/);
  assert.doesNotMatch(mainUiFlowSource, /data-script-editor-location-field/);
  assert.doesNotMatch(mainUiFlowSource, /data-script-editor-city-mounted-building/);
  assert.doesNotMatch(mainUiFlowSource, /data-script-editor-building-arrangement-field/);
  assert.doesNotMatch(mainUiFlowSource, /data-script-editor-building-layout-field/);
  assert.doesNotMatch(mainUiFlowSource, /data-script-editor-city-primary-npc/);
  assert.doesNotMatch(mainUiFlowSource, /data-script-editor-location-menu-field/);
  assert.doesNotMatch(mainUiFlowSource, /data-script-editor-location-access-field/);
  ...
  assert.match(sessionSource, /data-script-editor-event-repeatable/);
  assert.match(sessionSource, /data-script-editor-event-binding-field/);
  assert.match(sessionSource, /data-script-editor-minigame-field/);
  assert.match(sessionSource, /data-script-editor-relation-kind\^="story-related-"/);
  assert.match(sessionSource, /data-script-editor-person-trade-enabled/);
  assert.match(sessionSource, /data-script-editor-location-field/);
  assert.match(sessionSource, /data-script-editor-city-mounted-building/);
  assert.match(sessionSource, /data-script-editor-building-arrangement-field/);
  assert.match(sessionSource, /data-script-editor-building-layout-field/);
  assert.match(sessionSource, /data-script-editor-city-primary-npc/);
  assert.match(sessionSource, /data-script-editor-location-menu-field/);
  assert.match(sessionSource, /data-script-editor-location-access-field/);
