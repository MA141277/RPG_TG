...
- Goal:
  - `Promote MEMO-025 and its evidence draft into a governed successor target for event-centered authoring, no-scene routing truth, runtime-pack/runtime-state convergence, and portrait resource ownership.`
- Required outcomes:
