...
- next_file: `docs/blueprints/queues/script-editor-legacy-structure-supersession-review-queue.md`
...
- `The latest governance action admitted queue.script-editor-legacy-structure-supersession-review after schema reference closeout routed legacy supersession residue back to version review.`
- `Resume from the active queue document and its supersession-disposition-review task.`
