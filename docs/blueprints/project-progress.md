...
- `target.city-building-module-entry-and-project-startup-authoring is open with active queue queue.city-building-module-entry-and-project-startup-authoring. Active task is runtime-startup-convergence; evidence-anchor reconcile, project-info-authoring, and city-building-module-entry are complete.`
