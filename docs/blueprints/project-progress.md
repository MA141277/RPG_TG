...
- `The latest governance action closed queue.script-editor-city-building-entry-and-npc-authoring-priority after the bounded priority city/building/NPC materialization export slice verified with no same-family residue.`
