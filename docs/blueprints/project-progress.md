...
- next_file: `docs/blueprints/queues/script-editor-city-building-entry-and-npc-authoring-priority-queue.md`
...
- `The latest governance action admitted queue.script-editor-city-building-entry-and-npc-authoring-priority as the active queue after condition runtime evaluation convergence routed priority city/building/NPC authoring as the next review subject.`
