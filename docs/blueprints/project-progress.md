...
- `The latest governance action closed queue.script-editor-condition-authoring-contract-freeze after freezing the typed condition authoring contract and routed condition runtime evaluation convergence back to version promotion review.`
