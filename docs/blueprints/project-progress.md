...
- `target.city-building-module-entry-and-project-startup-authoring is open with active queue queue.city-building-module-entry-and-project-startup-authoring. Active task is city-building-module-entry; evidence-anchor reconcile and project-info-authoring are complete.`
