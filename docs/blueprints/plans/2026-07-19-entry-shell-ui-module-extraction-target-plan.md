...
| --- | --- | --- | --- |
| `queue.entry-shell-ui-module-extraction` | `active` | `evidence-anchor-reconcile is complete; implementation is active` | `Admitted on 2026-07-19 from MEMO-011. Keeps startup/pre-game entry shell render extraction and visible behavior preservation together as one bounded active queue.` |
