...
| --- | --- | --- | --- |
| `queue.city-building-module-entry-and-project-startup-authoring` | `active` | `runtime-startup-convergence is the active task.` | `Evidence-anchor reconcile, project-info-authoring, and city-building-module-entry are complete; next work is normal/JSON/preview startup convergence.` |
