...
- active_version_plan: `docs/blueprints/plans/2026-07-17-script-editor-event-binding-post-closeout-fixups-target-plan.md`
- active_version_spec: `docs/blueprints/specs/2026-07-17-script-editor-event-binding-post-closeout-fixups-target.md`
...
| --- | --- | --- | --- |
| `target.script-editor-event-binding-post-closeout-fixups` | `docs/blueprints/specs/2026-07-17-script-editor-event-binding-post-closeout-fixups-target.md` | `docs/blueprints/plans/2026-07-17-script-editor-event-binding-post-closeout-fixups-target-plan.md` | `Open successor/fixup version created on 2026-07-17 after target.script-editor-event-binding-runtime-replacement closed. It inherits that closed version's event-binding runtime replacement outcomes and handles submit/merge blockers found during post-closeout validation: destination selector completion first, then runtime preview from in-memory Script Editor data.` |
