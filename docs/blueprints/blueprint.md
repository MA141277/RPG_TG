...
| `target.script-editor-event-centered-authoring-scene-retirement-and-portrait-resource-refactor` | `docs/blueprints/specs/2026-07-22-script-editor-event-centered-authoring-scene-retirement-and-portrait-resource-refactor-target.md` | `docs/blueprints/plans/2026-07-22-script-editor-event-centered-authoring-scene-retirement-and-portrait-resource-refactor-target-plan.md` | `Current active open target created on 2026-07-22 from MEMO-025 after no-over-narrowing review concluded scene retirement, event-only routing, no-scene runtime convergence, and portrait resources require a dedicated parent target. It records five bounded child candidates plus one required-final acceptance queue, but no child queue is admitted yet.` |
