...
| --- | --- | --- | --- |
| `target.city-building-definition-location-access-convergence` | `docs/blueprints/specs/2026-07-16-city-building-definition-location-access-convergence-target.md` | `docs/blueprints/plans/2026-07-16-city-building-definition-location-access-convergence-target-plan.md` | `Open on 2026-07-16 as the successor for city/building definition restructuring, no-visibility LocationAccessRuntime condition expressions, HouseRuntime deprivileging, city/building runtime status overlays, editor authoring, export/import validation, and map city-list compatibility preservation.` |
