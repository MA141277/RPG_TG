...
- active_version_plan: `docs/blueprints/plans/2026-07-20-ai-mod-draft-editor-project-target-plan.md`
- active_version_spec: `docs/blueprints/specs/2026-07-20-ai-mod-draft-editor-project-target.md`
...
| --- | --- | --- | --- |
| `target.ai-mod-draft-editor-project` | `docs/blueprints/specs/2026-07-20-ai-mod-draft-editor-project-target.md` | `docs/blueprints/plans/2026-07-20-ai-mod-draft-editor-project-target-plan.md` | `Open successor target created on 2026-07-20 after target.script-editor-event-binding-post-closeout-fixups closed. It owns the AI Mod Draft v1 schema, deterministic converter to Script Editor project package, package-writing CLI, env-only AI generation CLI foundation, and Script Editor landing-page AI generation panel.` |
| `target.script-editor-event-binding-post-closeout-fixups` | `docs/blueprints/specs/2026-07-17-script-editor-event-binding-post-closeout-fixups-target.md` | `docs/blueprints/plans/2026-07-17-script-editor-event-binding-post-closeout-fixups-target-plan.md` | `Closed on 2026-07-20 after explicit operator confirmation; destination selector completion, destination family coverage correction, content-entry family correction, and runtime preview-from-memory are historical evidence with no remaining same-version candidate queue.` |
