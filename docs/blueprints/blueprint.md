...
- active_version: `target.script-editor-prd-alignment`
- active_version_plan: `docs/blueprints/plans/2026-07-13-script-editor-prd-alignment-target-plan.md`
- active_version_spec: `docs/blueprints/specs/2026-07-13-script-editor-prd-alignment-target.md`
...
| --- | --- | --- | --- |
| `target.script-editor-prd-alignment` | `docs/blueprints/specs/2026-07-13-script-editor-prd-alignment-target.md` | `docs/blueprints/plans/2026-07-13-script-editor-prd-alignment-target-plan.md` | `Opened on 2026-07-13 as the live successor version after the bounded implementation baseline closed; this version governs PRD alignment on top of docs/script-editor-prd.md, now has the workspace/navigation, project-selection/layout, person-authoring, city-building, dialogue-event-story, minigame-binding, and preview-validation-export queues closed as historical evidence, and currently sits in version-level promotion review with queue.script-editor-prd-workbench-ui-visual-alignment recorded as the next same-family candidate.` |
