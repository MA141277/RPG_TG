...
- Next Step: `Review, commit, and push this second Task 4 slice. After that, decide whether navigation-time-follow-up city-enter should also migrate off scene-runtime into story-runtime, or whether that deserves a new dedicated follow-up plan.`
