...
- Current Focus: `Short-table human draw-discard now auto-draws without a dedicated short draw button, keeps the incoming draw card visually separated and hover-liftable, locks discard arming to a single tile at a time, and adds short-only tile depth layers so hand/public/discard rows read more clearly.`
- Next Step: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table auto-draw/armed-discard follow-up when requested.`
- Verification: `RED bundled-node tests/tavern-short-gamble-domain.test.cjs + tests/tavern-short-gamble-house.test.cjs + tests/tavern-short-gamble-ui-contract.test.cjs failed because short draw-discard still allowed armed-tile switching, the human draw-discard turn still waited for an explicit draw action, the short overlay still exposed confirm-discard before arming a tile, and the short renderer/CSS still lacked incoming-card and tile-depth hooks. GREEN after implementation bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe .\\node_modules\\typescript\\bin\\tsc -p tsconfig.test.json passed; bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-domain.test.cjs passed 12/12; bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-house.test.cjs passed 9/9; bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs passed 21/21; and bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe tools\\lint-superpowers-plans.mjs passed.`
- Notes: `This follow-up only changes short-table draw-discard UX and short tile presentation: the session auto-draws on the human draw-discard turn, the short overlay only exposes confirm-discard after one discardable tile is armed, incoming hand tiles carry a dedicated typed flag for spacing/highlight, and short tiles gain depth-top/depth-bottom rendering helpers. It does not change long-mode rules, tavern-entry debug bypass behavior, or shared entrypoint ownership.`
...
- Status: `completed-but-open`
- Last Updated: `2026-08-03`
- Current Focus: `Short-table floating action buttons now sit another 20px higher again, so the live in-play button rail moves closer to the hand area while preserving the current centered width, claim-row stack, and settlement-button mounting rules.`
- Next Step: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table action-rail-minus-another-20px follow-up when requested.`
- Verification: `RED bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs failed because the short action-rail CSS still used margin-top: 40px on desktop and 32px on mobile instead of the new 20px / 12px offsets. GREEN after implementation C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe .\\node_modules\\typescript\\bin\\tsc -p tsconfig.test.json passed; C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs passed 16/16; and C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe tools\\lint-superpowers-plans.mjs passed.`
- Notes: `This follow-up only moves the short in-play floating action rail upward by another 20px: desktop margin-top changes from 40px to 20px and mobile margin-top changes from 32px to 12px. It does not change button contents, claim countdown layout, side-seat anchors, settlement actions, or long-mode layout rules.`
- Historical Execution State Note: `The focus/next-step/verification/notes lines below are the previous batch snapshot and are superseded by the update above until the next cleanup pass.`

- Status: `completed-but-open`
- Last Updated: `2026-08-03`
- Current Focus: `Short-table floating action buttons now sit 20px higher again, so the live in-play button rail moves closer to the hand area while keeping its current centered width, claim-row behavior, and settlement-button mounting rules unchanged.`
- Next Step: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table action-rail-minus-20px follow-up when requested.`
- Verification: `RED bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs failed because the short action-rail CSS still used margin-top: 60px on desktop and 52px on mobile instead of the new 40px / 32px offsets. GREEN after implementation C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe .\\node_modules\\typescript\\bin\\tsc -p tsconfig.test.json passed; C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs passed 16/16; and C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe tools\\lint-superpowers-plans.mjs passed.`
- Notes: `This follow-up only moves the short in-play floating action rail upward by 20px: desktop margin-top changes from 60px to 40px and mobile margin-top changes from 52px to 32px. It does not change button contents, claim countdown layout, side-seat anchors, settlement actions, or long-mode layout rules.`
- Historical Execution State Note: `The focus/next-step/verification/notes lines below are the previous batch snapshot and are superseded by the update above until the next cleanup pass.`

- Status: `completed-but-open`
- Last Updated: `2026-08-03`
- Current Focus: `Short-table left and right side-seat discard lanes now sit another 30px lower, with the exposed-meld lanes beneath them also shifted down another 30px so the side seats keep the same fixed vertical order while side discard rows render lower beneath the raised text block.`
- Next Step: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table side-discard-lanes-plus-30px follow-up when requested.`
- Verification: `RED bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs failed because the short left/right side-seat discard anchors still used top: 48px / 42px and the exposed-meld anchors beneath them still used top: 96px / 82px. GREEN after implementation C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe .\\node_modules\\typescript\\bin\\tsc -p tsconfig.test.json passed; C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs passed 16/16; and C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe tools\\lint-superpowers-plans.mjs passed.`
- Notes: `This follow-up only moves the short left/right side-seat discard lanes down another 30px and shifts the exposed-meld lanes beneath them down by the same amount to preserve the fixed summary -> discard -> meld order. It does not change the side text anchor, top seat, bottom seat, public-card stage, action rail, or long-mode layout rules.`
- Historical Execution State Note: `The focus/next-step/verification/notes lines below are the previous batch snapshot and are superseded by the update above until the next cleanup pass.`

- Status: `completed-but-open`
- Last Updated: `2026-08-03`
- Current Focus: `Short-table left and right side seats now pin their summary, discard lane, and exposed-meld lane to separate fixed anchors, with the side NPC text block lifted another 50px and discard tiles rendered directly beneath it so side-seat content no longer drifts when new discards or melds appear.`
- Next Step: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table side-seat-fixed-anchors follow-up when requested.`
- Verification: `RED bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs failed because left/right short seats still rendered meld rows before discard rows and the short side-seat CSS still used shared auto-flow anchors instead of fixed height plus absolute summary/discard/meld anchors. GREEN after implementation C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe .\\node_modules\\typescript\\bin\\tsc -p tsconfig.test.json passed; C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs passed 16/16; and C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe tools\\lint-superpowers-plans.mjs passed.`
- Notes: `This follow-up only re-anchors the short left/right side seats: summary stays on top, discards render directly below it, exposed melds stay on a lower fixed lane, and the side summary block is lifted another 50px. It does not change the top seat, bottom seat, public-card stage, action rail, or long-mode layout rules.`
- Historical Execution State Note: `The focus/next-step/verification/notes lines below are the previous batch snapshot and are superseded by the update above until the next cleanup pass.`

- Status: `completed-but-open`
- Last Updated: `2026-08-03`
- Current Focus: `Short-table top enemy seat now sits another 30px lower, so the north-side NPC summary/discard/meld block moves down as one anchored unit without shifting the public-card stage, side seats, player seat, or action rail.`
- Next Step: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table top-seat-plus-30px follow-up when requested.`
- Verification: `RED bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs failed because the short top seat CSS still used top: -32px instead of the new top: -2px anchor. GREEN after implementation C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe .\\node_modules\\typescript\\bin\\tsc -p tsconfig.test.json passed; C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs passed 16/16; and C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe tools\\lint-superpowers-plans.mjs passed.`
- Notes: `This follow-up only changes the short top seat anchor from top: -32px to top: -2px so the top NPC block moves down another 30px; it does not change top-seat width, public-card centering, player-hand offsets, claim flow, or long-mode layout rules.`
- Historical Execution State Note: `The focus/next-step/verification/notes lines below are the previous batch snapshot and are superseded by the update above until the next cleanup pass.`

- Status: `completed-but-open`
- Last Updated: `2026-08-03`
- Current Focus: `Short-table now keeps claimed meld cards locked for the rest of the current hand and normalizes public discard/exposed-meld tiles to one fixed size, so later draw turns cannot discard meld cards and two-digit ranks no longer stretch those public rows.`
- Next Step: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table persistent-meld-lock/fixed-public-tile follow-up when requested.`
- Verification: `RED bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-domain.test.cjs tests\\tavern-short-gamble-ui-contract.test.cjs failed because later draw turns still allowed discarding meld cards, the overlay still wired gamble-play-tile:wan-7 on meld cards after claim resolution, and short seat discard/meld CSS still used min-width/min-height instead of fixed tile sizing. GREEN after implementation C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe .\\node_modules\\typescript\\bin\\tsc -p tsconfig.test.json passed; C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-domain.test.cjs tests\\tavern-short-gamble-ui-contract.test.cjs passed 27/27; and C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe tools\\lint-superpowers-plans.mjs passed.`
- Notes: `This follow-up only extends short-table meld-card locking across the rest of the current hand and fixes short public discard/exposed-meld tile sizing to the existing meld baseline; it does not change claim priority, forced-discard sequencing, seat anchors, or long-mode layout rules.`
- Historical Execution State Note: `The focus/next-step/verification/notes lines below are the previous batch snapshot and are superseded by the update above until the next cleanup pass.`

- Status: `completed-but-open`
- Last Updated: `2026-08-03`
- Current Focus: `Short-table center rendering no longer shows the pending incoming-card note, so the center stage now displays only the public cards while pendingIncomingCard data remains available for short-hand flow control and action availability.`
- Next Step: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table pending-incoming-note removal follow-up when requested.`
- Verification: `RED bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs failed because the short center markup still rendered "待入手 draw-5". GREEN after implementation C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe .\\node_modules\\typescript\\bin\\tsc -p tsconfig.test.json passed; C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs passed 15/15; and C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe tools\\lint-superpowers-plans.mjs passed.`
- Notes: `This follow-up only removes the short center pending-incoming-card note from tavern-house-view rendering. It does not change pendingIncomingCard overlay data, draw/discard action flow, seat discard lanes, lower-left broadcast logs, or long-mode layout rules.`
- Historical Execution State Note: `The focus/next-step/verification/notes lines below are the previous batch snapshot and are superseded by the update above until the next cleanup pass.`

- Status: `completed-but-open`
- Last Updated: `2026-08-03`
- Current Focus: `Short-table seat rendering now uses position-aware section ordering, so the bottom player seat renders exposed melds and discards ahead of the fixed summary block and played cards now appear directly above the player's name/chip text without shifting that summary block.`
- Next Step: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table player-discard-above-summary follow-up when requested.`
- Verification: `RED bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs failed because the short bottom-seat markup still rendered the player summary before the player discard row. GREEN after implementation C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe .\\node_modules\\typescript\\bin\\tsc -p tsconfig.test.json passed; C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs passed 15/15; and C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe tools\\lint-superpowers-plans.mjs passed.`
- Notes: `This follow-up only changes short-table seat section ordering in tavern-house-view so the bottom player seat keeps its summary block fixed below its exposed-meld/discard lanes. It does not change seat overlay data, seat CSS anchors, lower-left broadcast logs, or long-mode layout rules.`
- Historical Execution State Note: `The focus/next-step/verification/notes lines below are the previous batch snapshot and are superseded by the update above until the next cleanup pass.`

- Status: `completed-but-open`
- Last Updated: `2026-08-03`
- Current Focus: `Short-table public-card frame no longer echoes the latest visible discard, so the center card stage only shows public cards plus the pending incoming card while discard visibility stays on seat discard lanes and the lower-left broadcast log.`
- Next Step: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table public-card discard-note removal follow-up when requested.`
- Verification: `RED bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs failed because short markup still rendered "traveler 打出 discard-7" inside the public-card frame. GREEN after implementation C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe .\\node_modules\\typescript\\bin\\tsc -p tsconfig.test.json passed; C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs passed 15/15; and C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe tools\\lint-superpowers-plans.mjs passed.`
- Notes: `This follow-up only removes the short center-frame visible-discard note from tavern-house-view rendering. It does not change visibleDiscard overlay data, seat discard lanes, pending incoming card notes, lower-left broadcast logs, or long-mode layout rules.`
- Historical Execution State Note: `The focus/next-step/verification/notes lines below are the previous batch snapshot and are superseded by the update above until the next cleanup pass.`

- Status: `completed-but-open`
- Last Updated: `2026-08-03`
- Current Focus: `Short-table floating action buttons now sit another 40px lower and the player-owned bottom discard seat is also lowered another 40px, so the live action rail and player discard lane both move closer to the lower edge while the hand panel, public-card stage, and other seat anchors stay unchanged.`
- Next Step: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table lower-action-rail/player-discard follow-up when requested.`
- Verification: `RED bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs failed because the short player seat anchor still used bottom 114px/100px and the short action rail still used margin-top 20px/12px. GREEN after implementation C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe .\\node_modules\\typescript\\bin\\tsc -p tsconfig.test.json passed; C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs passed 15/15; and C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe tools\\lint-superpowers-plans.mjs passed.`
- Notes: `This follow-up only changes the short player bottom seat anchor and the short floating action-rail offset: desktop seat bottom moves from 114px to 74px, mobile seat bottom moves from 100px to 60px, desktop action margin-top moves from 20px to 60px, and mobile action margin-top moves from 12px to 52px; no hand-panel, public-card, top-seat, or long-mode layout rules change.`
- Historical Execution State Note: `The focus/next-step/verification/notes lines below are the previous batch snapshot and are superseded by the update above until the next cleanup pass.`

- Status: `completed-but-open`
- Last Updated: `2026-08-03`
- Current Focus: `Short-table now removes the visible "我的手牌" label from the player hand area and lifts the top enemy seat block another 50px, so the upper seat summary/discard/meld cluster sits higher while the public-card stage, hand rail, and other seat anchors stay unchanged.`
- Next Step: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table hand-label/top-seat follow-up when requested.`
- Verification: `RED bundled-node C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs failed because short markup still contained "我的手牌" and the top enemy seat anchor still used top 18px. GREEN after implementation C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe .\\node_modules\\typescript\\bin\\tsc -p tsconfig.test.json passed; C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe --test --test-isolation=none tests\\tavern-short-gamble-ui-contract.test.cjs passed 15/15; and C:\\Users\\29636\\.cache\\codex-runtimes\\codex-primary-runtime\\dependencies\\node\\bin\\node.exe tools\\lint-superpowers-plans.mjs passed.`
- Notes: `This follow-up only changes the short hand-area label and the short top seat anchor: the visible "我的手牌" copy is removed and aria-label becomes "手牌区域", while the top enemy seat anchor moves from top 18px to -32px; no public-card, action-rail, player-seat, or long-mode layout rules change.`
- Historical Execution State Note: `The focus/next-step/verification/notes lines below are the previous batch snapshot and are superseded by the update above until the next cleanup pass.`
- Status: `running`
...
- 2026-08-03
  - Summary: `Switched tavern short draw-discard to an auto-draw + armed-discard flow: the player's turn now auto-draws into pendingIncomingCard, confirm-discard only appears after exactly one discardable tile is armed, clicking the armed tile again cancels it, switching to another tile while armed is ignored, and short tiles now render explicit depth-top/depth-bottom layers.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-domain.test.cjs + tests/tavern-short-gamble-house.test.cjs + tests/tavern-short-gamble-ui-contract.test.cjs failed because short draw-discard still allowed armed-tile switching, the human draw-discard turn still waited for an explicit draw action, the short overlay still exposed confirm-discard before arming a tile, and the short renderer/CSS still lacked incoming-card and tile-depth hooks. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-domain.test.cjs passed 12/12; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-house.test.cjs passed 9/9; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 21/21; and bundled-node tools/lint-superpowers-plans.mjs passed.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table auto-draw/armed-discard follow-up when requested.`

- 2026-08-03
  - Summary: `Swapped the tavern short-table discard and exposed-meld rows at all four seats under the approved B layout, so the bottom seat now renders discard -> meld -> summary, the top seat keeps summary first with discard above meld, and the left/right seats keep summary first with meld above discard.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed because the left/right short seats still rendered summary -> discard -> meld, the top short seat still rendered summary -> meld -> discard, and the side-seat CSS anchors still kept the old discard/meld top positions. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 17/17; and bundled-node tools/lint-superpowers-plans.mjs passed.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table discard-meld-row-swap follow-up when requested.`

- 2026-08-03
  - Summary: `Raised the tavern short-table floating action rail another 20px again, so the live in-play button row now sits even closer to the hand area while preserving the current centered width, claim-row stack, and settlement-button behavior.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed because the short action-rail CSS still used margin-top: 40px on desktop and 32px on mobile instead of 20px / 12px. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 16/16; and bundled-node tools/lint-superpowers-plans.mjs passed.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table action-rail-minus-another-20px follow-up when requested.`

- 2026-08-03
  - Summary: `Raised the tavern short-table floating action rail another 20px, so the live in-play button row now sits closer to the hand area while preserving the current centered width, claim-row stack, and settlement-button behavior.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed because the short action-rail CSS still used margin-top: 60px on desktop and 52px on mobile instead of 40px / 32px. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 16/16; and bundled-node tools/lint-superpowers-plans.mjs passed.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table action-rail-minus-20px follow-up when requested.`

- 2026-08-03
  - Summary: `Lowered the tavern short-table left and right side-seat discard lanes another 30px and shifted the exposed-meld lanes beneath them down by the same amount, so side-seat discards now render lower while the fixed summary -> discard -> meld order stays intact.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed because the short left/right side-seat discard anchors still used top: 48px / 42px and the exposed-meld anchors beneath them still used top: 96px / 82px. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 16/16; and bundled-node tools/lint-superpowers-plans.mjs passed.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table side-discard-lanes-plus-30px follow-up when requested.`

- 2026-08-03
  - Summary: `Re-anchored the tavern short-table left and right side seats so each side now uses fixed summary/discard/meld lanes, lifts the side NPC text block another 50px, and keeps discard tiles directly below that text block instead of letting side content drift when new discards or melds appear.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed because left/right short seats still rendered meld rows before discard rows and the short side-seat CSS still used shared auto-flow anchors instead of fixed anchor lanes. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 16/16; and bundled-node tools/lint-superpowers-plans.mjs passed.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table side-seat-fixed-anchors follow-up when requested.`

- 2026-08-03
  - Summary: `Lowered the tavern short-table top enemy seat another 30px, so the north-side NPC summary/discard/meld block moves down as one unit while the public-card stage, player seat, side seats, and action rail stay unchanged.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed because the short top seat CSS still used top: -32px instead of top: -2px. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 16/16; and bundled-node tools/lint-superpowers-plans.mjs passed.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table top-seat-plus-30px follow-up when requested.`

- 2026-08-03
  - Summary: `Kept tavern short claimed meld cards locked for the rest of the current hand and normalized short public discard/exposed-meld tiles to one fixed size, so later draw turns cannot discard meld cards and two-digit ranks no longer stretch those public rows.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-domain.test.cjs + tests/tavern-short-gamble-ui-contract.test.cjs failed because later draw turns still allowed discarding meld cards, the overlay still wired meld cards after claim resolution, and the short seat discard/meld CSS still used min-width/min-height instead of fixed sizing. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-domain.test.cjs tests/tavern-short-gamble-ui-contract.test.cjs passed 27/27; and bundled-node tools/lint-superpowers-plans.mjs passed.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table persistent-meld-lock/fixed-public-tile follow-up when requested.`

- 2026-08-03
  - Summary: `Removed the tavern short-table center pending-incoming note, so the center stage now shows only the public cards while pendingIncomingCard state stays available behind the scenes for short-hand flow control.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed because the short center markup still rendered "待入手 draw-5". GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 15/15; and bundled-node tools/lint-superpowers-plans.mjs passed.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table pending-incoming-note removal follow-up when requested.`

- 2026-08-03
  - Summary: `Adjusted tavern short-table seat rendering so the bottom player seat now shows exposed melds/discards above the fixed summary block, making played cards appear directly above the player's name/chip text while the other seat orderings stay unchanged.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed because the short bottom-seat markup still rendered the player summary before the player discard row. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 15/15; and bundled-node tools/lint-superpowers-plans.mjs passed.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table player-discard-above-summary follow-up when requested.`

- 2026-08-03
  - Summary: `Removed the tavern short-table center-frame discard note so the public-card frame no longer repeats which tile was just played, while the pending incoming card note, seat discard lanes, and lower-left broadcast log remain unchanged.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed because short markup still rendered "traveler 打出 discard-7" inside the public-card frame. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 15/15; and bundled-node tools/lint-superpowers-plans.mjs passed for 93 files.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table public-card discard-note removal follow-up when requested.`

- 2026-08-03
  - Summary: `Lowered the tavern short-table floating action rail another 40px and lowered the player-owned bottom discard seat another 40px, keeping the hand panel, raised public-card stage, and the other three seat anchors unchanged.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed because the short player seat anchor still used bottom 114px/100px and the short action rail still used margin-top 20px/12px. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 15/15; and bundled-node tools/lint-superpowers-plans.mjs passed for 93 files.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table lower-action-rail/player-discard follow-up when requested.`

- 2026-08-03
  - Summary: `Removed the visible "我的手牌" label from the tavern short-table hand area and lifted the top enemy seat block another 50px, keeping the raised public-card stage, lower player discard lane, and floating action rail unchanged.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed because short markup still rendered "我的手牌" and the top seat anchor still used top 18px. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 15/15; and bundled-node tools/lint-superpowers-plans.mjs passed for 93 files.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table hand-label/top-seat follow-up when requested.`

- 2026-08-03
  - Summary: `Lowered the tavern short-table player bottom discard seat another 40px, bringing the player-owned table discard lane closer to the hand area while preserving the raised public-card stage and the rest of the four-edge seat layout.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed on the short player seat anchor still using bottom 154px on desktop. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 15/15; and bundled-node tools/lint-superpowers-plans.mjs passed for 93 files.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table player-discard offset follow-up when requested.`

- 2026-08-03
  - Summary: `Raised the tavern short-table public-card stage another 50px on top of the new four-edge felt layout, keeping the hand lane, floating action rail, seat summaries, and exposed-meld/discard rendering unchanged.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed on the short public-card anchor still using calc(50% - 40px) on desktop and calc(44% - 24px) on mobile. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 15/15; and bundled-node tools/lint-superpowers-plans.mjs passed for 93 files.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table public-card offset follow-up when requested.`

- 2026-08-03
  - Summary: `Replaced the tavern short-table sidebar with a four-edge felt layout: each seat now renders its name/chips plus real exposed-meld and discard tiles in-place around the table, while the public-card stage shifts upward and the player hand/action rail shifts downward to open a dedicated middle discard lane.`
  - Verification: `RED sequential bundled-node tsc -p tsconfig.test.json plus tests/tavern-short-gamble-ui-contract.test.cjs failed on the missing tablePosition/meldGroups/discardTiles overlay data, lingering sidebar markup, and missing short seat-layout CSS. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 15/15; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-domain.test.cjs tests/tavern-short-gamble-house.test.cjs passed 18/18; bundled-node tsc --noEmit -p tsconfig.json passed; and bundled-node tools/lint-superpowers-plans.mjs passed for 93 files.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table four-edge seat-layout follow-up when requested.`

- 2026-08-03
  - Summary: `Moved the tavern short-table wagering status chips out of the old short header strip and into the centered public-card stage so phase / pot / current-bet labels now render directly above the public cards.`
  - Verification: `RED sequential bundled-node tsc -p tsconfig.test.json plus tests/tavern-short-gamble-ui-contract.test.cjs failed on the short c-tavern-gamble__meta row still living inside the felt header and on the missing short-center meta centering rule. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 15/15; bundled-node tsc --noEmit -p tsconfig.json passed; and bundled-node tools/lint-superpowers-plans.mjs passed for 93 files.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table public-card status follow-up when requested.`

- 2026-08-03
  - Summary: `Moved the tavern short-table broadcast log out of the centered floating strip and into a framed lower-left info window so the panel now reads as a narrower, taller boxed broadcast area without changing the centered public-card stage or the floating action rail.`
  - Verification: `RED sequential bundled-node tsc -p tsconfig.test.json plus tests/tavern-short-gamble-ui-contract.test.cjs failed on the short log still being centered and borderless. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 15/15; bundled-node tsc --noEmit -p tsconfig.json passed; and bundled-node tools/lint-superpowers-plans.mjs passed for 93 files.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table lower-left broadcast-window follow-up when requested.`

- 2026-08-03
  - Summary: `Removed the old dark short-play backdrop from tavern short live actions, switched betting / draw-discard / claim windows to a single center-aligned floating rail that only renders currently available controls during the player's turn, kept the close button as the sole always-mounted top-bar control, centered the hand/log/public-card axes, and removed the short sidebar divider so the left panel shares the felt background.`
  - Verification: `RED sequential bundled-node tsc -p tsconfig.test.json plus tests/tavern-short-gamble-ui-contract.test.cjs failed on the short hand-area CSS property order. GREEN after implementation bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 15/15; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-domain.test.cjs passed 10/10; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-house.test.cjs passed 8/8; bundled-node tsc --noEmit -p tsconfig.json passed; bundled-node tools/lint-superpowers-plans.mjs passed for 93 files; bundled-node vite build passed after an unsandboxed rerun because sandboxed esbuild spawn returned EPERM.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table floating-action-rail follow-up when requested.`

- 2026-08-03
  - Summary: `Moved short-table in-play buttons into an on-demand panel inside the hand area, kept only the close button always mounted in the top bar, centered the public-card stage against the whole short table, merged the sidebar into the shared green felt background, and fixed the test build so tavern house-view changes are compiled into .test-dist.`
  - Verification: `RED bundled-node tests/tavern-short-gamble-ui-contract.test.cjs failed on the short-play panel still rendering outside the hand area, stale NPC-turn gameplay buttons, and the old centered-in-felt / absolute-action short CSS; GREEN bundled-node tsc -p tsconfig.test.json passed; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-ui-contract.test.cjs passed 15/15; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-domain.test.cjs passed 10/10; bundled-node node --test --test-isolation=none tests/tavern-short-gamble-house.test.cjs passed 8/8; bundled-node tsc --noEmit -p tsconfig.json passed.`
  - Next: `Keep the temporary tavern-entry debug bypass unchanged, then refresh the local client and review/commit the short-table on-demand action-panel follow-up when requested.`
