...
- Current Focus: `Runtime-only twenty-second slice landed immediately after the scene/dialogue continuation checkpoint: navigation-runtime's routeHouseEnterEvent(...) no longer stops at route-only dispatchEventRoute, so house on-enter events now re-enter through shared dispatchRuntimeRequest while the public enter-house navigation API stays unchanged.`
- Next Step: `Continue shrinking the remaining direct runtime-entry helpers after navigation enter-house convergence: the next likely owner seam is event-runtime.routeTriggeredEvent(...), or another adjacent helper that still bypasses shared runtime-dispatch while keeping public APIs stable.`
- Verification: `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run build:test` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test tests/game-store-playable-shells.test.cjs` passed 3/3; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test tests/event-continuation-runtime.test.cjs` passed 20/20; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "scene runtime routes automatic nextEvent continuation through the shared runtime-dispatch seam|dialogue runtime routes automatic nextEvent continuation through the shared runtime-dispatch seam" tests/dialogue-runtime-compatibility.test.cjs` passed 2/2; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "navigation runtime routes house on-enter events through the shared runtime-dispatch seam" tests/navigation-runtime-access.test.cjs` passed 1/1; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "scene dialogue runtime continuation route convergence keeps owner wrappers on one shared continuation seam|event continuation contract narrowing keeps pure resolution separate from routed compatibility continuation|game store keeps scene and choice continuation on a shared runtime-dispatch seam|navigation enter-house convergence keeps on-enter event activation on the shared event-router seam" tests/robustness.test.cjs` passed 4/4; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run typecheck` pending rerun after this doc sync; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run lint:plans` pending rerun after this doc sync.`
...
- 2026-08-06
  - Summary: `Completed the fifteenth payload-first RED/GREEN slice. `parseScriptEditorProject(...)` now runs `storyNodes` through `normalizeScriptEditorStoryNodeRecord(...)`, so story-node title and other existing headline-field normalizations are applied at the same project-entry seam as events, bindings, progress records, and settlements.`
  - Verification: `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "story node normalization preserves canonical headline fields|script-editor project parse normalizes story-node authoring at the entry seam" tests/script-editor-runtime-preview-compat.test.cjs` first failed because `parseScriptEditorProject(...)` still passed raw story nodes through unchanged, then passed after loader-side story-node normalization landed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "script-editor project parse keeps story-node normalization on one entry seam" tests/robustness.test.cjs` passed after the loader seam guard was added; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run build:test` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run typecheck` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test tests/script-editor-runtime-preview-compat.test.cjs` passed 34/34.`
  - Next: `Pick the next payload-first asymmetry after story-node entry normalization: likely remaining pack-level entry seams outside story-dialogue-event-authoring or the next non-router direct caller family.`
- 2026-08-06
  - Summary: `Completed the sixteenth payload-first RED/GREEN slice. `parseScriptEditorProject(...)` now runs both `minigames` and `flows` through their launch authoring normalizers, and `normalizeScriptEditorMinigameRecord(...)` was widened to preserve the runtime-significant fields already used by imported templates, including `integrationId`, `settlementId`, owner/trigger settings, `launchPayload`, and `outcomeRoutes`.`
  - Verification: `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "flow normalization preserves canonical launch headline fields|minigame normalization preserves canonical launch headline fields|script-editor project parse normalizes minigame and flow authoring at the entry seam|imported zhuyuanzhang script-editor template stays exportable for runtime preview" tests/script-editor-runtime-preview-compat.test.cjs` first failed because `parseScriptEditorProject(...)` still passed raw minigames/flows through unchanged, then failed again because the minigame normalizer dropped template-owned runtime fields like `integrationId`, and finally passed after loader-side flow/minigame normalization landed and the minigame normalizer preserved those runtime fields; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "script-editor project parse keeps minigame and flow normalization on one entry seam" tests/robustness.test.cjs` passed after the loader seam guard was added; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run build:test` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run typecheck` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test tests/script-editor-runtime-preview-compat.test.cjs` passed 37/37; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run lint:plans` passed.`
  - Next: `Pick the next payload-first asymmetry after minigame/flow entry normalization: likely remaining pack-level entry seams such as city/building/portrait records or the next non-router direct caller family.`
- 2026-08-06
  - Summary: `Completed the seventeenth payload-first RED/GREEN slice. `parseScriptEditorProject(...)` now runs both `cities` and `buildings` through the shared city/building authoring normalizers, and `city-building-authoring` now trims optional headline fields so region/map node ids, descriptions, background ids, and menu-instance references stabilize at the same project-entry seam as the rest of the pack-owned records.`
  - Verification: `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "city normalization preserves canonical location headline fields|building normalization preserves canonical location headline fields|script-editor project parse normalizes city and building authoring at the entry seam" tests/script-editor-runtime-preview-compat.test.cjs` first failed because `parseScriptEditorProject(...)` still passed raw city/building records through unchanged, then failed again because `city-building-authoring` preserved whitespace in optional headline fields, and finally passed after loader-side city/building normalization landed and optional-string trimming moved onto the shared location seam; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "script-editor project parse keeps city and building normalization on one entry seam" tests/robustness.test.cjs` passed after the loader seam guard was added; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run build:test` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run typecheck` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test tests/script-editor-runtime-preview-compat.test.cjs` passed 40/40; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run lint:plans` passed.`
  - Next: `Pick the next payload-first asymmetry after city/building entry normalization: likely the remaining portrait-level pack entry seam, or the next runtime caller family that still bypasses router/runtime-dispatch.`
- 2026-08-06
  - Summary: `Completed the eighteenth payload-first RED/GREEN slice. `parseScriptEditorProject(...)` now runs both `portraits` and `portraitVariants` through the shared portrait authoring normalizers, and `portrait-authoring` now trims label/path/reference fields so portrait pack records enter the shared project parse seam in canonical form before any runtime preview/export step uses them.`
  - Verification: `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "portrait normalization preserves canonical asset headline fields|portrait variant normalization preserves canonical portrait reference fields|script-editor project parse normalizes portrait authoring at the entry seam" tests/script-editor-runtime-preview-compat.test.cjs` first failed because portrait normalizers still preserved whitespace in label/path/reference fields and `parseScriptEditorProject(...)` still passed portrait records through unchanged, then passed after loader-side portrait normalization landed and the shared portrait normalizers trimmed those canonical string fields; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "script-editor project parse keeps portrait normalization on one entry seam" tests/robustness.test.cjs` first failed because the loader had no portrait normalization seam, then passed after the dedicated imports/mapping were added; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run build:test` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run typecheck` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test tests/script-editor-runtime-preview-compat.test.cjs` passed 43/43; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run lint:plans` passed.`
  - Next: `Pick the next runtime-only convergence slice from remaining caller families that still bypass router/runtime-dispatch, now that the pack-level project parse seams have been folded into shared normalization entrypoints.`
- 2026-08-06
  - Summary: `Completed the nineteenth runtime-only RED/GREEN slice. The `continueToEvent(...)` compatibility seam still exists for non-owner scene/choice fallback callers, but it no longer starts follow-up events locally: it now rehydrates the target event into the shared event-router activation path through `dispatchEventRoute(...)` plus `createEventRouteActivationHandlers(...)`, keeping continuation ownership aligned with the router bridge without forcing immediate caller API churn.`
  - Verification: `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "continueToEvent routes fallback continuation through the shared event-router seam" tests/event-continuation-runtime.test.cjs` first failed because `continueToEvent(...)` still used `startEvent(...)` directly, then passed after the compatibility seam was reimplemented on top of `dispatchEventRoute(...)`; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "event continuation contract narrowing keeps pure resolution separate from routed compatibility continuation" tests/robustness.test.cjs` first failed because the source still referenced `startEvent(...)`, then passed after the continuation helper moved onto the shared router activation seam; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run build:test` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run typecheck` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test tests/event-continuation-runtime.test.cjs` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run lint:plans` passed.`
  - Next: `Pick the next runtime-only convergence slice after continuation seam routing: likely the remaining `startEvent(...)` + `runSceneUntilPause(...)` helper family, or another caller that still bypasses shared runtime-dispatch while owner wrappers remain stable.`
- 2026-08-07
  - Summary: `Completed the twentieth runtime-only RED/GREEN slice. The remaining non-owner direct caller family turned out to be application/state/game-store: syncScene/advanceScene/chooseOption previously delegated to scene-runner and choice-resolver without any explicit owner-side continuation seam, so event follow-up entry stopped at continueToEvent's compatibility bridge. game-store now injects continueFromSceneEvent / continueFromChoiceEvent callbacks that route follow-up events through dispatchRuntimeRequest, while choice-resolver gained the matching optional callback path and existing public APIs stayed stable.`
  - Verification: `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test tests/game-store-playable-shells.test.cjs` first failed because neither syncScene nor chooseOption hit dispatchRuntimeRequest, then passed after game-store continuation routing landed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "game store keeps scene and choice continuation on a shared runtime-dispatch seam" tests/robustness.test.cjs` first failed because src/application/state/game-store.ts still lacked dispatchRuntimeRequest and explicit continuation callback seams, then passed after the source-level owner wiring landed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run build:test` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test tests/event-continuation-runtime.test.cjs` passed 20/20; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run typecheck` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run lint:plans` passed.`
  - Next: `Audit the next owner-side helper family that still dispatches routed continuation through dispatchEventRoute without shared runtime-dispatch, with routeSceneRuntimeContinuationEvent as the most likely next slice.`
- 2026-08-07
  - Summary: `Completed the twenty-first runtime-only RED/GREEN slice. The owner-side scene/dialogue continuation helper routeSceneRuntimeContinuationEvent previously re-entered follow-up events through dispatchEventRoute only, so scene-runtime and dialogue-runtime still bypassed shared runtime-dispatch even after game-store converged. routeSceneRuntimeContinuationEvent now wraps that event-entry path in dispatchRuntimeRequest, and dialogue-runtime inherits the same convergence through its existing reuse of the helper.`
  - Verification: `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "scene runtime routes automatic nextEvent continuation through the shared runtime-dispatch seam|dialogue runtime routes automatic nextEvent continuation through the shared runtime-dispatch seam" tests/dialogue-runtime-compatibility.test.cjs` first failed because neither runtime hit dispatchRuntimeRequest, then passed after routeSceneRuntimeContinuationEvent moved onto dispatchRuntimeRequest; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "scene dialogue runtime continuation route convergence keeps owner wrappers on one shared continuation seam" tests/robustness.test.cjs` first failed because src/core/runtime/scene-runtime.ts still only referenced dispatchEventRoute in the continuation helper, then passed after the helper converged; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run build:test` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test tests/event-continuation-runtime.test.cjs` passed 20/20; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run typecheck` passed; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run lint:plans` passed.`
  - Next: `Audit event-runtime / navigation-runtime direct event-entry helpers and choose the next adjacent owner seam that still bypasses shared runtime-dispatch.`
- 2026-08-07
  - Summary: `Completed the twenty-second runtime-only RED/GREEN slice. navigation-runtime's routeHouseEnterEvent(...) still re-entered house on-enter events through dispatchEventRoute only, so the enter-house owner seam had not yet moved onto shared runtime-dispatch. routeHouseEnterEvent now wraps the same repository/activation-handler route in dispatchRuntimeRequest, keeping navigation enter-house behavior unchanged while converging the ownership seam.`
  - Verification: `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "navigation runtime routes house on-enter events through the shared runtime-dispatch seam" tests/navigation-runtime-access.test.cjs` first failed because routeHouseEnterEvent never hit dispatchRuntimeRequest, then passed after navigation-runtime moved onto dispatchRuntimeRequest; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" node --test --test-name-pattern "navigation enter-house convergence keeps on-enter event activation on the shared event-router seam" tests/robustness.test.cjs` first failed because the helper still referenced dispatchEventRoute directly, then passed after the routeHouseEnterEvent helper converged; `PATH="/Users/ms/.cache/codex-runtimes/codex-primary-runtime/dependencies/node/bin:$PATH" pnpm run build:test` passed.`
  - Next: `Rerun typecheck/lint after this doc sync, then choose whether event-runtime.routeTriggeredEvent(...) is the next adjacent direct-entry seam to converge.`
