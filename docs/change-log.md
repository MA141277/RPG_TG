...
### Changed
- Added [src/application/playables/flow/shell.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/playables/flow/shell.ts:1) and updated [src/domain/playables/flow.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/domain/playables/flow.ts:1) plus [src/core/runtime/playable-runtime-registries.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/runtime/playable-runtime-registries.ts:1) so every authored `playableShells` flow record now contributes a canonical shell-backed playable definition, derived default integration id, and per-flow shell registration instead of relying on a runtime-only `building-flow` fallback line.
- Updated [src/core/runtime/playable-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/runtime/playable-runtime.ts:1), [src/application/events/event-playable-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/events/event-playable-runtime.ts:1), [src/application/events/event-route-command-dispatch.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/events/event-route-command-dispatch.ts:1), [src/application/building/building-container-event-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/building/building-container-event-runtime.ts:1), and [src/main.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/main.ts:1) so flow launch/action/exit now travel only through the shared shell runtime path; the shared runtime no longer imports `launchFlowPlayable` or `reduceFlowPlayable`, and event/building hosts no longer own a dedicated `launchFlow` branch.
- Updated [src/application/content/active-game-content.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/content/active-game-content.ts:1), [src/application/content/content-pack-loader.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/content/content-pack-loader.ts:1), [src/application/scenario/scenario-pack-loader.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/scenario/scenario-pack-loader.ts:1), [src/modules/script-editor/application/runtime-pack-export.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/modules/script-editor/application/runtime-pack-export.ts:1), [src/modules/script-editor/application/runtime-pack-import.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/modules/script-editor/application/runtime-pack-import.ts:1), [src/content/scenario-packs/zhuyuanzhang/pack.json](/Users/ms/.codex/worktrees/1109/RPG_TG/src/content/scenario-packs/zhuyuanzhang/pack.json:1), and [src/modules/script-editor/builtin-templates/zhuyuanzhang/pack.json](/Users/ms/.codex/worktrees/1109/RPG_TG/src/modules/script-editor/builtin-templates/zhuyuanzhang/pack.json:1) so the canonical content family/file truth is now `playableShells` plus `playable-shells.json`; the older `flowPlayables` / `flow-playables.json` naming no longer survives on the live runtime/export/import path.
- Updated [src/ui/app-render.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/ui/app-render.ts:1), [src/application/presenter/app-render-coordinator.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/presenter/app-render-coordinator.ts:1), and [src/core/contracts/playable-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/contracts/playable-runtime.ts:1) so stage rendering now consumes optional shell `renderStage` / `renderOverlay` hooks instead of a hardcoded `flow-playable-view` branch keyed by pack-owned playable shell lookups.
- Updated [src/core/registry/builtin-playable-definition-registry.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/registry/builtin-playable-definition-registry.ts:1), [src/core/registry/builtin-playable-integration-registry.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/registry/builtin-playable-integration-registry.ts:1), [src/core/runtime/mod-first-compatibility.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/runtime/mod-first-compatibility.ts:1), and [src/modules/script-editor/ui/main-ui-script-editor-module.js](/Users/ms/.codex/worktrees/1109/RPG_TG/src/modules/script-editor/ui/main-ui-script-editor-module.js:1) to delete the retired `building-flow` playable identity from registries, compatibility types, and editor-facing labels.
- Updated [src/modules/script-editor/application/runtime-pack-export.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/modules/script-editor/application/runtime-pack-export.ts:1), [src/domain/event.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/domain/event.ts:1), [src/content/scenario-packs/zhuyuanzhang/events.json](/Users/ms/.codex/worktrees/1109/RPG_TG/src/content/scenario-packs/zhuyuanzhang/events.json:1), and [src/modules/script-editor/builtin-templates/zhuyuanzhang/events.json](/Users/ms/.codex/worktrees/1109/RPG_TG/src/modules/script-editor/builtin-templates/zhuyuanzhang/events.json:1) so authored runtime events now launch flows only through `launchPlayable` with derived flow integration ids; `launchFlow` is no longer part of the runtime event contract or the shipped demo/template data.
- Added/updated [tests/event-flow-playable-runtime.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/event-flow-playable-runtime.test.cjs:1), [tests/flow-playable-dotted-id-runtime.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/flow-playable-dotted-id-runtime.test.cjs:1), [tests/event-owned-playable-completion-parity.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/event-owned-playable-completion-parity.test.cjs:1), and [tests/city-building-mount-authoring.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/city-building-mount-authoring.test.cjs:1) to lock the new boundaries: no runtime `flow` special branch, no `building-flow`, no template `launchFlow`, the script-editor authoring UI points at the real module surface, and dotted flow ids plus event-owned follow-up routing still launch, reduce, settle, and hand off correctly through the unified shell path.

### Impact
- Pack-owned flow content now behaves as `playableShells` under the same launch/session/settlement/render contract as the other unified playables, instead of remaining a parallel runtime family or a separately-named content truth.
...
### Changed
- Updated [src/application/playables/grain-accounting/shell.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/playables/grain-accounting/shell.ts:1), [src/application/playables/medicine-compounding/shell.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/playables/medicine-compounding/shell.ts:1), [src/core/registry/builtin-playable-shell-registry.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/registry/builtin-playable-shell-registry.ts:1), and [src/core/registry/builtin-playable-definition-registry.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/registry/builtin-playable-definition-registry.ts:1) so `grain-accounting` and `medicine-compounding` now ship as canonical playable shells under one `src/application/playables/*` path, and builtin registration reads those shell manifests instead of relying on host-side action branches as the live contract.
- Updated [src/core/runtime/playable-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/runtime/playable-runtime.ts:1) so launch/action/exit for shell-owned house playables now route through the shared shell registry, receive one generic runtime snapshot payload, settle through shared playable result routing, and emit a generic `playable-shell-result` overlay instead of house-specific overlay/result ownership.
- Updated [src/ui/views/playables/house-playable-overlay.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/ui/views/playables/house-playable-overlay.ts:1) and [src/main.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/main.ts:1) so the host now only consumes presenter-driven shell actions and optional `detail.autoTickMs`; it no longer hardcodes `answer-correct`, `answer-wrong`, `select-herb`, `clear`, `finish`, or per-playable timer ownership.
- Added [tests/house-playables-shell-runtime.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/house-playables-shell-runtime.test.cjs:1) to lock the new runtime path: launch into shell session, complete through shell action/tick, settle through shared runtime routing, and render the generic shell result overlay without the retired hardcoded host branches.
- Updated [src/core/contracts/interactive-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/contracts/interactive-runtime.ts:1), [src/core/runtime/interactive-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/runtime/interactive-runtime.ts:1), [src/core/registry/builtin-playable-definition-registry.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/registry/builtin-playable-definition-registry.ts:1), and [src/main.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/main.ts:1) so `city-begging` no longer occupies a special `interactive runtime` identity path; launch/completion now use the standard playable runtime entrypoints and the builtin definition registry now advertises `playable.city-begging.` as the canonical command prefix.
- Updated [tests/city-begging-stamina-regression.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/city-begging-stamina-regression.test.cjs:1) and the targeted city-begging assertions inside [tests/robustness.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/robustness.test.cjs:1) so the repository no longer treats `interactive.city-begging.complete` as the live completion contract.
- Updated [src/application/playables/builtin/city-begging/city-begging-runtime-controller.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/playables/builtin/city-begging/city-begging-runtime-controller.ts:1), [src/application/playables/builtin/city-begging/city-begging-minigame-view.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/playables/builtin/city-begging/city-begging-minigame-view.ts:1), [src/application/runtime/council-priority-city-begging-coordinator.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/runtime/council-priority-city-begging-coordinator.ts:1), and [src/main.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/main.ts:1) so the city-begging view/controller no longer owns a detached runtime state or private completion cache; pointer/tick now forward straight into shared playable runtime requests and the confirm path reads completion only from canonical runtime state.
- Added [tests/city-begging-overlay-controller.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/city-begging-overlay-controller.test.cjs:1) and updated the remaining city-begging controller assertions in [tests/robustness.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/robustness.test.cjs:1) to lock the new boundary: the controller may schedule frames and pointer listeners, but lifecycle state advancement belongs to playable runtime callbacks rather than a second detached state machine.
- Added [src/application/playables/city-begging/shell.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/playables/city-begging/shell.ts:1) and [src/application/playables/city-begging/index.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/playables/city-begging/index.ts:1), updated [src/core/runtime/playable-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/runtime/playable-runtime.ts:1), [src/ui/views/playables/house-playable-overlay.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/ui/views/playables/house-playable-overlay.ts:1), [src/ui/app-render.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/ui/app-render.ts:1), and [src/main.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/main.ts:1) so `city-begging` itself now runs as a canonical playable shell with shell-owned overlay render/sync hooks instead of a runtime-side fallback seam.
- Updated [src/application/app-shell.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/app-shell.ts:1), [src/core/contracts/runtime-state.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/contracts/runtime-state.ts:1), [src/core/runtime/state-sync-core-seam.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/runtime/state-sync-core-seam.ts:1), and the affected runtime/app transition files so the source contract no longer exposes `beggingMiniGameState`; canonical `city-begging` session state now lives only under shared playable runtime ownership.
- Added [tests/city-begging-shell-runtime.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/city-begging-shell-runtime.test.cjs:1) and cleaned the remaining targeted `city-begging` assertions inside [tests/robustness.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/robustness.test.cjs:1) so launch, active session state, completion confirmation, and contract cleanup are all guarded against regression.
- Added [src/minigames/temple-copy-scripture/shell.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/minigames/temple-copy-scripture/shell.ts:1), updated [src/core/registry/builtin-playable-shell-registry.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/registry/builtin-playable-shell-registry.ts:1), [src/core/registry/builtin-playable-definition-registry.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/registry/builtin-playable-definition-registry.ts:1), [src/core/runtime/playable-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/runtime/playable-runtime.ts:1), [src/core/runtime/interactive-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/runtime/interactive-runtime.ts:1), [src/main.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/main.ts:1), and the temple playable declarations under [src/content/scenario-packs/zhuyuanzhang/playables.json](/Users/ms/.codex/worktrees/1109/RPG_TG/src/content/scenario-packs/zhuyuanzhang/playables.json:1) plus [src/modules/script-editor/builtin-templates/zhuyuanzhang/playables.json](/Users/ms/.codex/worktrees/1109/RPG_TG/src/modules/script-editor/builtin-templates/zhuyuanzhang/playables.json:1) so `temple-copy-scripture` now launches through the shared shell registry with a canonical `playable.temple-copy-scripture.` prefix instead of the retired `interactive.*` special path.
- Deleted the obsolete [src/minigames/temple-copy-scripture/runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/minigames/temple-copy-scripture/runtime.ts:1) wrapper and added [tests/temple-copy-scripture-shell-runtime.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/temple-copy-scripture-shell-runtime.test.cjs:1) so this minigame no longer keeps a second launch/action owner outside the canonical playable shell line.

### Impact
- `grain-accounting` and `medicine-compounding` now follow the same runtime shell ownership shape instead of each keeping a separate host-side overlay/action/timer contract.
- New house playables can target the same shared shell path by registering a playable shell and presenter contract, rather than reopening `main.ts` or `house-playable-overlay.ts` for per-minigame wiring.
- `city-begging` is now on that same shared playable line end-to-end: the live session is shell-owned, the host consumes generic shell overlay hooks, and the retired `beggingMiniGameState` app/runtime seam is no longer part of the source contract.
- `temple-copy-scripture` now follows the same shell-registry route as the other minigame packages, so Script Editor/runtime content no longer needs to keep a dedicated `interactive.temple-copy-scripture.*` command namespace alive just to launch temple house gameplay.

## 2026-07-26 Script Editor Canonical Draft Id And Authoring Copy Convergence

## 2026-08-02 Unified Playable Shell Final-State Enforcement

### Changed
- Added the governing design [docs/superpowers/specs/2026-08-02-unified-playable-shell-final-state-enforcement-design.md](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/docs/superpowers/specs/2026-08-02-unified-playable-shell-final-state-enforcement-design.md:1) to define the repository's final playable package rule: every runnable playable must live under `src/playables/<playable-id>/`, expose one unified runtime-owned shell contract, and fail closed at registry/runtime/editor intake when that shell is missing.
- Marked [docs/superpowers/specs/2026-08-02-temple-copy-scripture-independent-package-design.md](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/docs/superpowers/specs/2026-08-02-temple-copy-scripture-independent-package-design.md:1) as superseded because its earlier package-plus-host-adapter split is no longer an allowed repository target after the approved "no intermediate state, no compatibility layer" rule.
- Recorded the explicit prohibition on adapter seams, compatibility re-export layers, dual runnable playable directories, and fallback loading for non-shell-compliant playables so future cleanup work treats these as acceptance blockers rather than deferred follow-up.
- Added the shared `PlayableShell` contract to [src/core/contracts/playable-runtime.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/contracts/playable-runtime.ts:132), created the new shell registries at [src/core/registry/playable-shell-registry.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/registry/playable-shell-registry.ts:1) and [src/core/registry/builtin-playable-shell-registry.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/registry/builtin-playable-shell-registry.ts:1), and extended [src/core/runtime/playable-runtime-registries.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/runtime/playable-runtime-registries.ts:1) so the runtime now has an explicit shell-registry surface ready for the next direct-runtime cutover.
- Strengthened [tests/robustness.test.cjs](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/tests/robustness.test.cjs:11222) so the Task 2 gate now exercises real shell-registry behavior (`register/get` and default registry access) instead of relying only on source-text pattern checks.
- Deleted the playable-host-adapter seam and its temple-only runtime glue, then rewired [src/core/runtime/playable-runtime.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/runtime/playable-runtime.ts:1) plus [src/ui/views/playables/house-playable-overlay.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/ui/views/playables/house-playable-overlay.ts:1) so direct shell lookup now owns temple launch, command reduction, result overlay rendering, and fail-closed missing-shell reporting.
- Moved `temple-copy-scripture` into the canonical [src/playables/temple-copy-scripture](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/playables/temple-copy-scripture/index.ts:1) package root and removed the retired runnable roots under [src/minigames/temple-copy-scripture](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/minigames/temple-copy-scripture/index.ts:1) and [src/application/playables/builtin/temple-copy-scripture](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/playables/builtin/temple-copy-scripture/index.ts:1) in the same batch.
- Updated the retained Zhu Yuanzhang temple-copy-scripture playable payloads in [src/core/registry/builtin-playable-integration-registry.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/registry/builtin-playable-integration-registry.ts:1), [src/content/scenario-packs/zhuyuanzhang/playable-integrations.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/content/scenario-packs/zhuyuanzhang/playable-integrations.json:1), and [src/content/scenario-packs/zhuyuanzhang/events.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/content/scenario-packs/zhuyuanzhang/events.json:1) plus the matching builtin-template tables so `皇觉寺 - 抄经` now launches from self-contained prompt config instead of requiring host-side `activityId -> title/briefing/orderLine` translation.
- Confirmed the retained Zhu Yuanzhang `flow-playables.json` tables are empty and therefore retired the leftover built-in `building-flow` residue instead of migrating it: [src/core/registry/builtin-playable-definition-registry.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/registry/builtin-playable-definition-registry.ts:1), [src/core/registry/builtin-playable-integration-registry.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/registry/builtin-playable-integration-registry.ts:1), [src/core/runtime/playable-runtime.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/runtime/playable-runtime.ts:1), and [src/modules/script-editor/ui/main-ui-script-editor-module.js](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/modules/script-editor/ui/main-ui-script-editor-module.js:1) no longer advertise or special-case `building-flow`.

### Impact
- The repository now has one approved end-state for current and future playables: runtime-owned shared shell, canonical `src/playables/<id>/` placement, and fail-closed intake rules instead of package-specific glue patterns.
- Any current work on `temple-copy-scripture` or later playable migrations must now converge directly to the final shell path; intermediate package/adapter designs are documented as rejected architecture rather than pending cleanup.
- The shared runtime can now grow toward direct shell loading without introducing a second gameplay-specific contract family; the remaining cutover work is deleting host-adapter ownership from runtime execution rather than inventing another integration seam.
- `temple-copy-scripture` is now the first real direct shell package in the repository: runtime launch no longer depends on host adapters, result overlays no longer depend on temple-specific render functions, `building-flow` no longer survives as a fake builtin after its authored tables were emptied, and the next migration step is bringing the remaining actually-runnable builtin playable set onto that same canonical path.

## 2026-08-02 Activity QTE Canonical Shell Migration Slice

### Changed
- Added the canonical [src/playables/activity-qte](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/playables/activity-qte/index.ts:1) package root with package-local contract, manifest, session, reducer, presenter, settlement, and export entry so `activity-qte` now has one repository-approved shell directory instead of keeping its runnable definition under the retired [src/application/playables/activity-qte/activity-qte-definition.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/playables/activity-qte/activity-qte-definition.ts:1) path.
- Updated [src/application/activity/activity-runner.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/activity/activity-runner.ts:1), [src/core/registry/builtin-playable-definition-registry.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/registry/builtin-playable-definition-registry.ts:1), and the authored Zhu Yuanzhang playable tables in [src/content/scenario-packs/zhuyuanzhang/playables.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/content/scenario-packs/zhuyuanzhang/playables.json:1) plus [src/modules/script-editor/builtin-templates/zhuyuanzhang/playables.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/modules/script-editor/builtin-templates/zhuyuanzhang/playables.json:1) so builtin definition lookup and authored command routing now resolve `activity-qte` through the canonical shell manifest and the shared `playable.activity-qte.*` command namespace instead of the older `interactive.activity-qte.*` ids.
- Updated [src/application/runtime/runtime-request-seam.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/runtime/runtime-request-seam.ts:1), [src/application/runtime/interactive-action-coordinator.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/runtime/interactive-action-coordinator.ts:1), and [src/main.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/main.ts:1) so `activity-qte` tick, board/command actions, stop, and result-close now enter the shared playable request path (`createPlayableActionRequest(...)` / `createExitPlayableRequest(...)`) instead of continuing to travel through interactive-runtime-only action ids.
- Expanded [tests/robustness.test.cjs](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/tests/robustness.test.cjs:1) with source and runtime guards for the canonical `activity-qte` package path, the removed legacy definition path, the new shared playable request routing, and the builtin command-prefix cutover.

### Impact
- `activity-qte` has now entered the same final-state migration path as `temple-copy-scripture`: one canonical shell package root, one shared playable request namespace, and no new compatibility wrapper added for the removed legacy definition file.
- This batch is intentionally only the first cutover slice. [src/core/runtime/playable-runtime.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/runtime/playable-runtime.ts:1) still contains direct `activity-qte` lifecycle ownership branches, so the remaining work is to widen the shared shell contract until those branches can be deleted rather than keeping hidden runtime-local ownership.
- Script Editor builtin authored data now points at the same command family the runtime request seam uses, which removes one more legacy split between creator-authored playable instances and the actual active runtime path for `activity-qte`.

## 2026-08-02 Temple Copy Scripture Standalone Package Sample

### Changed
- Replaced the temple copy-scripture wrapper under [src/minigames/temple-copy-scripture](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/minigames/temple-copy-scripture/index.ts:1) with a host-agnostic package surface split into package-local contract, session, reducer, and presenter files, so the first minigame sample now lives as an independent mechanic package instead of importing RPG_TG runtime-state, dialogue, or `activity-qte` implementation details directly.
- Added the dedicated host adapter seam under [src/application/playables/builtin/temple-copy-scripture](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/playables/builtin/temple-copy-scripture/index.ts:1) and updated [src/core/runtime/playable-runtime.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/runtime/playable-runtime.ts:1), [src/core/runtime/interactive-runtime.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/runtime/interactive-runtime.ts:1), [src/core/registry/builtin-playable-definition-registry.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/registry/builtin-playable-definition-registry.ts:1), and [src/core/registry/builtin-playable-integration-registry.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/registry/builtin-playable-integration-registry.ts:1) so temple launch, action reduction, settlement routing, and authored integration metadata now flow through the shared playable contract instead of direct temple-specific runtime branches.
- Updated [src/main.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/main.ts:1) and [src/ui/views/playables/house-playable-overlay.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/ui/views/playables/house-playable-overlay.ts:1) so temple command dispatch no longer depends on `main.ts` shell special-casing, the result-close path accepts standalone package `*-result` overlays, and the temple building menu can launch, settle, and dismiss the new package overlay from the host house surface.
- Added a dedicated playable host-adapter registry under [src/core/contracts/playable-host-adapter.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/contracts/playable-host-adapter.ts:1), [src/core/registry/playable-host-adapter-registry.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/registry/playable-host-adapter-registry.ts:1), and [src/core/registry/builtin-playable-host-adapter-registry.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/registry/builtin-playable-host-adapter-registry.ts:1), then rewired [src/core/runtime/playable-runtime.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/runtime/playable-runtime.ts:1), [src/core/runtime/playable-runtime-registries.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/runtime/playable-runtime-registries.ts:1), and [src/application/playables/builtin/temple-copy-scripture](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/playables/builtin/temple-copy-scripture/index.ts:1) so the shared runtime and host overlay now discover temple package launch/reduce/exit/render behavior through a registry seam instead of importing temple-specific branches directly.
- Updated [tests/robustness.test.cjs](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/tests/robustness.test.cjs:1) plus the governed spec/plan documents under [docs/superpowers/specs/2026-08-02-temple-copy-scripture-independent-package-design.md](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/docs/superpowers/specs/2026-08-02-temple-copy-scripture-independent-package-design.md:1) and [docs/superpowers/plans/2026-08-02-temple-copy-scripture-independent-package-implementation.md](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/docs/superpowers/plans/2026-08-02-temple-copy-scripture-independent-package-implementation.md:1) to lock the standalone package boundary, adapter seam, and browser acceptance evidence.
- Updated [src/content/scenario-packs/zhuyuanzhang/events.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/content/scenario-packs/zhuyuanzhang/events.json:1), [src/content/scenario-packs/zhuyuanzhang/playable-integrations.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/content/scenario-packs/zhuyuanzhang/playable-integrations.json:1), [src/content/scenario-packs/zhuyuanzhang/flow-playables.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/content/scenario-packs/zhuyuanzhang/flow-playables.json:1), [src/content/scenario-packs/zhuyuanzhang/dialogues.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/content/scenario-packs/zhuyuanzhang/dialogues.json:1), [src/content/scenario-packs/zhuyuanzhang/text-entries.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/content/scenario-packs/zhuyuanzhang/text-entries.json:1), and the matching builtin-template files so `皇觉寺 - 打扫庭院` and `皇觉寺 - 挑水` now launch visible `activity-qte` playable instances directly, the dead `皇觉寺 - 寺内工作` flow shell is removed, and `皇觉寺 - 捐香火` now routes through a formal dialogue instead of hidden `flow` continue shells.
- Updated the same `zhuyuanzhang` scenario-pack and builtin-template tables so `皇觉寺 - 评定` and `将领府邸 - 议事` now resolve as formal dialogue-backed events instead of `launchFlow` residue, while the non-demo `grain-accounting` and `medicine-compounding` sample integrations are normalized to `manual-launch` rather than dangling behind emptied demo building menus.
- Further trimmed [src/content/scenario-packs/zhuyuanzhang/menu-resources.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/content/scenario-packs/zhuyuanzhang/menu-resources.json:1), [src/content/scenario-packs/zhuyuanzhang/event-bindings.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/content/scenario-packs/zhuyuanzhang/event-bindings.json:1), [src/content/scenario-packs/zhuyuanzhang/events.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/content/scenario-packs/zhuyuanzhang/events.json:1), [src/content/scenario-packs/zhuyuanzhang/flow-playables.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/content/scenario-packs/zhuyuanzhang/flow-playables.json:1), and [src/content/scenario-packs/zhuyuanzhang/dialogues.json](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/content/scenario-packs/zhuyuanzhang/dialogues.json:1) plus the matching builtin-template files so the demo pack now keeps authored direct-building routes only for `皇觉寺` and `将领府邸`; non-demo building menus remain as empty shells rather than dangling event targets.

### Impact
- `temple-copy-scripture` is now the first playable sample that can be treated as a transferable minigame package: the mechanic code lives under one independent directory, while RPG_TG-specific launch payload mapping, overlay projection, and settlement/handoff stay behind the host adapter seam.
- The shared playable runtime and shared house overlay no longer need to know the temple package by name; the remaining host-owned launch, action, exit, and overlay rendering behavior is now discovered through the builtin playable host-adapter registry seam.
- Script Editor authored building events still remain the only launch owner for the temple route, but the browser path now proves the full chain `寺庙 -> 抄经 -> 游玩 -> 结算 -> 收起结果 -> 返回寺庙菜单` without reintroducing direct `main.ts` or runtime hardcoding for this one building mechanic.
- The preserved Huangjue Temple chores now align better with the current creator-visible surface: `打扫庭院` and `挑水` no longer depend on hidden `flow` text nodes for an extra Continue dialog, the dead `寺内工作` chooser shell no longer sits behind an invisible binding path, and `捐香火` is now editable as a formal dialogue-backed event instead of a hidden flow-only text shell.
- `皇觉寺 - 评定` and `将领府邸 - 议事` now sit on the same visible Script Editor event/dialogue chain as `捐香火`, so the retained demo building routes no longer depend on hidden review `flow` shells.
- The built-in Zhu Yuanzhang demo template is now materially narrower on the creator-visible building surface: direct building event truth is concentrated on `皇觉寺 / 将领府邸`, while `自宅 / 帅府 / 茶馆 / 货栈 / 粮铺 / 药铺 / 客栈` no longer keep misleading direct-event, flow, or enter-dialogue residue inside the demo pack.

## 2026-07-31 Script Editor Playable Instance Tabs And Settlement Routing Authoring

### Changed
- Updated [src/modules/script-editor/application/minigame-binding-authoring.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/modules/script-editor/application/minigame-binding-authoring.ts:1), [src/modules/script-editor/application/runtime-pack-export.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/modules/script-editor/application/runtime-pack-export.ts:1), and [src/modules/script-editor/application/runtime-pack-import.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/modules/script-editor/application/runtime-pack-import.ts:1) so playable instances now author `configEntries` and ordered `settlementRoutes`, while runtime `integrationId` / `triggerId` / launch payload are derived during export instead of remaining creator-facing fields.
- Updated [src/core/contracts/playable-runtime.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/contracts/playable-runtime.ts:1), [src/core/runtime/playable-result-routing.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/runtime/playable-result-routing.ts:1), and [src/application/events/event-playable-runtime.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/events/event-playable-runtime.ts:1) so playable completion can resolve the first matching settlement route and continue through the authored target event instead of requiring the caller to synthesize follow-up routing outside the playable seam.
- Updated [src/modules/script-editor/ui/views/script-editor-workspace-view.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/modules/script-editor/ui/views/script-editor-workspace-view.ts:1), [src/modules/script-editor/application/workspace-shell.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/modules/script-editor/application/workspace-shell.ts:1), [src/modules/script-editor/ui/main-ui-script-editor-module.js](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/modules/script-editor/ui/main-ui-script-editor-module.js:1), [src/ui/main-ui/main-ui-flow.js](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/ui/main-ui/main-ui-flow.js:1), and [src/styles/script-editor.css](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/styles/script-editor.css:1) so the top workbench summary band is removed from the shared Script Editor shell, the `事件` and `玩法` workbenches now use tabbed headers with `基础` as the first tab, playable authoring now exposes `基础 / 配置组 / 结算组`, and shared input/select heights are aligned upward.

### Impact
- Script Editor creators no longer need to maintain retired playable binding jargon such as `接入方案` or creator-facing `结算实例`; they now author runtime tuning and completion routing directly on the playable instance.
- Event/settlement routing remains the only owner of final reward and stamina persistence, but playable instances can now decide which authored event branch should fire by returning facts that match ordered settlement routes.

## 2026-07-31 Playable Minigame Builtin Package Extraction

### Changed
- Updated [src/core/contracts/playable-runtime.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/contracts/playable-runtime.ts:1), [src/core/runtime/playable-result-routing.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/runtime/playable-result-routing.ts:1), and [src/core/runtime/playable-runtime.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/core/runtime/playable-runtime.ts:1) so `city-begging` completion now emits a shared settlement carrier through the playable runtime seam instead of keeping time-advance routing inline in the caller branch.
- Moved the active `city-begging` playable implementation, minigame runtime logic, view, and owned image assets into the dedicated [src/application/playables/builtin/city-begging](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/playables/builtin/city-begging:1) package, while leaving thin compatibility re-export shells at the legacy [src/application/playables/city-begging/city-begging-definition.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/playables/city-begging/city-begging-definition.ts:1), [src/application/minigames/city-begging-minigame.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/minigames/city-begging-minigame.ts:1), and [src/ui/views/minigames/city-begging-minigame-view.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/ui/views/minigames/city-begging-minigame-view.ts:1) paths.
- Moved the active `grain-accounting` playable definition behind the dedicated [src/application/playables/builtin/grain-accounting](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/playables/builtin/grain-accounting:1) package seam and converted the legacy [src/application/playables/grain-accounting/grain-accounting-definition.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/playables/grain-accounting/grain-accounting-definition.ts:1) path into a compat re-export shell so the old path no longer directly owns `applyAccountingReward(...)`.
- Added package-local [src/application/playables/builtin/grain-accounting/texts/index.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/playables/builtin/grain-accounting/texts/index.ts:1) and [src/application/playables/builtin/grain-accounting/assets/index.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/playables/builtin/grain-accounting/assets/index.ts:1) manifests, and updated [src/ui/views/playables/house-playable-overlay.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/ui/views/playables/house-playable-overlay.ts:1) to read grain-accounting copy from the builtin package instead of keeping gameplay copy inline in the shared overlay presenter.
- Updated [src/main.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/main.ts:1), [src/ui/app-render.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/ui/app-render.ts:1), [src/application/runtime/council-priority-city-begging-coordinator.ts](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/application/runtime/council-priority-city-begging-coordinator.ts:1), and [src/styles/prototype.css](/Users/ms/Desktop/workspace/RPG_TG/.worktrees/mod-first-dev/src/styles/prototype.css:1) so active city-begging runtime/render/style wiring resolves through the builtin package and its co-located asset directory instead of the older scattered `ui/化缘UI` references.

### Impact
- `city-begging` now has one portable package root that carries its runtime logic, view, and currently used assets together, making later cross-project transplantation materially simpler.
- The legacy public paths for `city-begging` and `grain-accounting` remain stable for current callers, but those paths no longer directly expose persistence helper ownership; the active implementation and owned copy/resources now sit behind the builtin package seams.
...
## 2026-07-27 Building Runtime Formal Menu Consumption Cutover

### Changed
- Updated [src/application/building/building-module-entry.ts](/D:/workspace/project/RPG_TG/src/application/building/building-module-entry.ts:1) and [src/application/presenter/stage-presenters.ts](/D:/workspace/project/RPG_TG/src/application/presenter/stage-presenters.ts:1) so building `action-menu` containers now resolve runtime actions from the active house `menuInstanceIds -> menuInstances -> menuResources` chain instead of consuming inline arrangement `items` as production truth.
- Updated [src/application/script-editor/menu-authoring.ts](/D:/workspace/project/RPG_TG/src/application/script-editor/menu-authoring.ts:1), [src/application/script-editor/city-building-authoring.ts](/D:/workspace/project/RPG_TG/src/application/script-editor/city-building-authoring.ts:1), and [src/ui/main-ui/main-ui-flow.js](/D:/workspace/project/RPG_TG/src/ui/main-ui/main-ui-flow.js:1) so legacy building arrangement action items formalize into building menu resources/instances, new arrangement containers no longer author inline action items as the active path, and the arrangement editor now treats `action-menu` as a layout shell with menu ownership delegated to the Menus tab.
- Updated [src/content/scenario-packs/zhuyuanzhang/houses.json](/D:/workspace/project/RPG_TG/src/content/scenario-packs/zhuyuanzhang/houses.json:1), [src/content/scenario-packs/zhuyuanzhang/building-arrangements.json](/D:/workspace/project/RPG_TG/src/content/scenario-packs/zhuyuanzhang/building-arrangements.json:1), [src/content/scenario-packs/zhuyuanzhang/menu-resources.json](/D:/workspace/project/RPG_TG/src/content/scenario-packs/zhuyuanzhang/menu-resources.json:1), and [src/content/scenario-packs/zhuyuanzhang/menu-instances.json](/D:/workspace/project/RPG_TG/src/content/scenario-packs/zhuyuanzhang/menu-instances.json:1) so the built-in pack now ships formal building menu resources/instances and house-level `menuInstanceIds` for the previously inline arrangement-owned building actions.
- Updated [tests/robustness.test.cjs](/D:/workspace/project/RPG_TG/tests/robustness.test.cjs:1) and [tests/city-building-mount-authoring.test.cjs](/D:/workspace/project/RPG_TG/tests/city-building-mount-authoring.test.cjs:1) so regression coverage now proves building runtime/action binding truth through formal menu resources and verifies that the retired inline arrangement action-item authoring controls no longer define the active workbench contract.

### Impact
- Building runtime now joins city runtime on the same formal menu ownership chain: houses hold `menuInstanceIds`, menu instances point to menu resources, and runtime action buttons consume those formal entries instead of arrangement-local action arrays.
- ACC-FORMAT-003 remains open until queue closeout review finishes, but the previously open same-family building-runtime menu gap is now covered and re-verified rather than left as an implementation residue.

### Changed
- Updated [src/application/city-menu/city-menu.ts](/D:/workspace/project/RPG_TG/src/application/city-menu/city-menu.ts:1), [src/application/city/city-module-entry.ts](/D:/workspace/project/RPG_TG/src/application/city/city-module-entry.ts:1), [src/application/presenter/stage-presenters.ts](/D:/workspace/project/RPG_TG/src/application/presenter/stage-presenters.ts:1), [src/application/presenter/app-render-coordinator.ts](/D:/workspace/project/RPG_TG/src/application/presenter/app-render-coordinator.ts:1), [src/main.ts](/D:/workspace/project/RPG_TG/src/main.ts:1), and [src/application/ui/app-click-coordinator.ts](/D:/workspace/project/RPG_TG/src/application/ui/app-click-coordinator.ts:1) so runtime city-menu selection, presenter output, and click routing now consume formal `menuResources` / `menuInstances` entry ids instead of hardcoded city panel branches as the production path.
- Updated [src/ui/views/city/city-view.ts](/D:/workspace/project/RPG_TG/src/ui/views/city/city-view.ts:1), [src/ui/views/city/city-module-view.ts](/D:/workspace/project/RPG_TG/src/ui/views/city/city-module-view.ts:1), and [src/ui/app-render.ts](/D:/workspace/project/RPG_TG/src/ui/app-render.ts:1) so the city shell renders formal runtime menu entries and dispatches `data-city-menu-entry-id` rather than the retired inline `data-city-menu-open` protocol.
- Added [src/content/scenario-packs/zhuyuanzhang/menu-resources.json](/D:/workspace/project/RPG_TG/src/content/scenario-packs/zhuyuanzhang/menu-resources.json:1) and [src/content/scenario-packs/zhuyuanzhang/menu-instances.json](/D:/workspace/project/RPG_TG/src/content/scenario-packs/zhuyuanzhang/menu-instances.json:1), and updated [src/content/scenario-packs/zhuyuanzhang/pack.json](/D:/workspace/project/RPG_TG/src/content/scenario-packs/zhuyuanzhang/pack.json:1) plus [src/content/scenario-packs/zhuyuanzhang/cities.json](/D:/workspace/project/RPG_TG/src/content/scenario-packs/zhuyuanzhang/cities.json:1), so the built-in pack now ships formal city menu resources/instances and city-local `menuInstanceIds` instead of leaving runtime menu truth inline.
- Updated [src/application/script-editor/menu-authoring.ts](/D:/workspace/project/RPG_TG/src/application/script-editor/menu-authoring.ts:1), [src/application/script-editor/city-building-authoring.ts](/D:/workspace/project/RPG_TG/src/application/script-editor/city-building-authoring.ts:1), and [tests/robustness.test.cjs](/D:/workspace/project/RPG_TG/tests/robustness.test.cjs:1) so active authoring records no longer keep empty inline `menuEntries` arrays or legacy inline-menu helper exports as the live workbench truth; the remaining `menuEntries` references are compatibility-only formalization and imported-data normalization seams.

### Impact
- Runtime and authoring now meet on the same formal menu chain: project-level menu resources/instances, location-level `menuInstanceIds`, and runtime-side city menu consumption from those same references.
- This advances ACC-FORMAT-003 to queue closeout review, but it does not itself declare ACC-FORMAT-003 closed. The remaining compatibility-only `menuEntries` shell and repository-sync gate still need explicit queue-closeout judgement.

## 2026-07-27 Script Editor Formal Menu Resource And Instance Authoring Slice

### Changed
- Added [src/application/script-editor/menu-authoring.ts](/D:/workspace/project/RPG_TG/src/application/script-editor/menu-authoring.ts:1) and updated [src/application/script-editor/editor-project-loader.ts](/D:/workspace/project/RPG_TG/src/application/script-editor/editor-project-loader.ts:1) plus [src/application/script-editor/minimal-workflow.ts](/D:/workspace/project/RPG_TG/src/application/script-editor/minimal-workflow.ts:1) so Script Editor projects now formalize legacy location-local `menuEntries` into project-level `menuResources` and `menuInstances`, while cities/buildings hang off `menuInstanceIds` on the active authoring path.
- Updated [src/ui/main-ui/main-ui-flow.js](/D:/workspace/project/RPG_TG/src/ui/main-ui/main-ui-flow.js:1) so the location `菜单` surface now edits formal menu instances/resources instead of mutating `location.menuEntries` as the active workbench truth, and the deep browser smoke under [tests/browser-script-editor-deep-actions-smoke.test.cjs](/D:/workspace/project/RPG_TG/tests/browser-script-editor-deep-actions-smoke.test.cjs:1) now exercises that converged menu path.
- Updated [src/application/script-editor/workspace-shell.ts](/D:/workspace/project/RPG_TG/src/application/script-editor/workspace-shell.ts:1), [src/application/script-editor/minimal-workflow.ts](/D:/workspace/project/RPG_TG/src/application/script-editor/minimal-workflow.ts:1), and [tests/robustness.test.cjs](/D:/workspace/project/RPG_TG/tests/robustness.test.cjs:1) so workspace validation, event-deletion cleanup, project parsing, and regression coverage all resolve missing menu instances/resources from the formal chain rather than from inline location-owned menu truth.

### Impact
- Script Editor creators now work through one formal menu reference chain on the active authoring surface: project-level resources and instances, then location-level `menuInstanceIds`.
- This does not yet close ACC-FORMAT-003. Runtime-side menu consumption still needs to move onto the same formal chain, and the remaining `menuEntries` compatibility residue on Script Editor location records still needs final retirement or non-production proof.

### Changed
- Updated [src/core/contracts/progression-runtime.ts](/D:/workspace/project/RPG_TG/src/core/contracts/progression-runtime.ts:1), [src/core/runtime/progression-runtime.ts](/D:/workspace/project/RPG_TG/src/core/runtime/progression-runtime.ts:1), and [src/application/story/story-runtime.ts](/D:/workspace/project/RPG_TG/src/application/story/story-runtime.ts:1) so progression runtime, settlement payloads, and story-side metric resolution now use stage-host reference semantics (`hostFamily` / `hostId` plus `trackStatesByHostKey`) instead of the older owner tuple.
- Updated [src/application/script-editor/story-dialogue-event-authoring.ts](/D:/workspace/project/RPG_TG/src/application/script-editor/story-dialogue-event-authoring.ts:1), [src/application/script-editor/runtime-pack-export.ts](/D:/workspace/project/RPG_TG/src/application/script-editor/runtime-pack-export.ts:1), and [src/application/scenario/scenario-pack-loader.ts](/D:/workspace/project/RPG_TG/src/application/scenario/scenario-pack-loader.ts:1) so Script Editor defaults, export validation, and scenario-pack loading now all expect the same host-reference progression contract and fail closed on retired `ownerTag`-style residue.
- Updated [src/ui/main-ui/main-ui-flow.js](/D:/workspace/project/RPG_TG/src/ui/main-ui/main-ui-flow.js:1) so stage-configuration and progression-binding controls now edit `hostFamily` / `hostId`, and newly created stage rules inherit the selected host family instead of the retired owner tuple.
- Updated [tests/story-runtime-progression-timing.test.cjs](/D:/workspace/project/RPG_TG/tests/story-runtime-progression-timing.test.cjs:1), [tests/browser-stage-settlement-smoke.test.cjs](/D:/workspace/project/RPG_TG/tests/browser-stage-settlement-smoke.test.cjs:1), the browser smoke fixture under [tests/fixtures/scenario-packs/browser-stage-settlement-smoke](/D:/workspace/project/RPG_TG/tests/fixtures/scenario-packs/browser-stage-settlement-smoke/pack.json:1), and [tests/robustness.test.cjs](/D:/workspace/project/RPG_TG/tests/robustness.test.cjs:1) with regression coverage for the host-reference contract across runtime state, export/import validation, Script Editor source guards, and authored settlement execution.

### Impact
- Stage configuration no longer depends on `ownerKind` / `ownerId` as the live progression contract; authored bindings, exported packs, runtime evaluation, and settlement payloads now speak one host-reference language.
- This slice advances ACC-FORMAT-003 on the stage side without claiming queue closeout: menu truth still remains inline on city/building records and still requires the later formal menu resource/instance/runtime convergence batch.
...
## 2026-08-02 Activity QTE Playable Shell Canonicalization

### Changed
- Added [src/application/playables/activity-qte/shell.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/playables/activity-qte/shell.ts) and [src/application/playables/activity-qte/index.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/playables/activity-qte/index.ts), promoting `activity-qte` into the same canonical shell registry path already used by the portable minigame packages.
- Updated [src/core/registry/builtin-playable-shell-registry.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/registry/builtin-playable-shell-registry.ts), [src/core/registry/builtin-playable-definition-registry.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/registry/builtin-playable-definition-registry.ts), [src/content/scenario-packs/zhuyuanzhang/playables.json](/Users/ms/.codex/worktrees/1109/RPG_TG/src/content/scenario-packs/zhuyuanzhang/playables.json), and [src/modules/script-editor/builtin-templates/zhuyuanzhang/playables.json](/Users/ms/.codex/worktrees/1109/RPG_TG/src/modules/script-editor/builtin-templates/zhuyuanzhang/playables.json) so `activity-qte` now uses the canonical `playable.activity-qte.` command surface instead of `interactive.activity-qte.*`.
- Updated [src/core/runtime/playable-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/runtime/playable-runtime.ts), [src/core/runtime/interactive-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/contracts/interactive-runtime.ts), [src/main.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/main.ts), [src/application/runtime/interactive-action-coordinator.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/runtime/interactive-action-coordinator.ts), and [src/ui/app-render.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/ui/app-render.ts) so launch/action/exit, overlay rendering, and result closeout all route through shared playable shell ownership; `interactive-runtime` no longer carries an `activity-qte` compatibility kind.
- Added [tests/activity-qte-shell-runtime.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/activity-qte-shell-runtime.test.cjs) and updated [tests/robustness.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/robustness.test.cjs) so the canonical shell path, command prefix, and compatibility removal stay guarded.

### Impact
- `activity-qte` now follows the same shell-only loading and action contract as the other unified minigame packages instead of keeping a second interactive-only route alive.
- Future minigame convergence can treat `activity-qte` as another shared shell slice, while `interactive-runtime` narrows toward the remaining non-minigame `story-battle` seam.

## 2026-08-03 Shell-Only Minigame Loading Guard

### Changed
- Updated [src/modules/script-editor/application/minigame-binding-authoring.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/modules/script-editor/application/minigame-binding-authoring.ts) and [src/modules/script-editor/application/runtime-pack-export.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/modules/script-editor/application/runtime-pack-export.ts) so Script Editor minigame authoring only exposes shell-backed playable options and runtime export now rejects any minigame binding whose `playableId` has no registered shell.
- Updated [src/application/scenario/scenario-pack-loader.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/scenario/scenario-pack-loader.ts) so runtime scenario packs fail closed when `playables` or `playableIntegrations` declare a shell-less playable id; Script Editor import now inherits that same loader rule instead of keeping a second compatibility path.
- Updated [src/core/registry/builtin-playable-shell-registry.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/registry/builtin-playable-shell-registry.ts), [src/core/registry/builtin-playable-definition-registry.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/registry/builtin-playable-definition-registry.ts), and [src/core/runtime/playable-runtime-registries.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/runtime/playable-runtime-registries.ts) so builtin shell/definition registration imports shells directly and default playable registries initialize lazily, removing the shell-registry circular initialization that surfaced once shell-backed options/export paths started consuming the shared registries at runtime.
- Added [tests/minigame-shell-guard.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/minigame-shell-guard.test.cjs) to guard the four shell-only constraints: editor options, runtime export rejection, scenario-pack loader rejection, and Script Editor runtime-pack import rejection.

### Impact
- New minigames must now ship a registered playable shell before they can appear in Script Editor authoring, export into runtime packs, or be loaded back into runtime/import flows.
- Shell-only loading is now enforced by the shared runtime/content path rather than by a project-local compatibility layer, which closes off another source of legacy playable residue similar to the earlier `flows` drift.

## 2026-08-03 Event-Owned Flow Launch Convergence

### Changed
- Updated [src/application/events/event-playable-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/events/event-playable-runtime.ts) so the shared event-owned playable seam now consumes both `launchPlayable` and `launchFlow` actions, stamping the source event id into the launched playable session either way.
- Updated [src/application/building/building-container-event-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/application/building/building-container-event-runtime.ts) to stop importing or directly calling `launchFlowPlayable`; building-container item actions now delegate flow launch to the same shared event playable runtime path already used for playable launch.
- Added [tests/event-flow-playable-runtime.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/event-flow-playable-runtime.test.cjs) to guard both the shared `launchFlow` event path and the removal of building-container-local flow lifecycle ownership.

### Impact
- Building-container hosts no longer privately own event-driven flow session launch, which removes one more flow-related residue path from outside the shared playable/event runtime line.
- `launchFlow` is still an authored event action family at this point, but its runtime ownership now converges with event-owned playable launch instead of staying as a building-local exception.

## 2026-08-03 Building-Flow Runtime Fallback Removal

### Changed
- Updated [src/core/runtime/playable-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/runtime/playable-runtime.ts) so flow launch and flow-session detection now rely only on concrete `flowPlayablesById` definitions or real flow session state, instead of treating the literal playable id `building-flow` as an implicit runtime fallback.
- Expanded [tests/event-flow-playable-runtime.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/event-flow-playable-runtime.test.cjs) to prove `building-flow` no longer launches successfully without a concrete flow definition and to guard against future reintroduction of `=== "building-flow"` runtime hardcoding.

### Impact
- Shared playable runtime no longer keeps a hidden id-based fallback for building flows; authored flow content must now be present explicitly for the launch path to activate.
- This removes another flow-specific compatibility residue from the runtime core and pushes the remaining flow behavior toward data-backed, registry-backed ownership only.

## 2026-08-03 Interactive Helper Residue Cleanup

### Changed
- Updated [src/core/runtime/playable-runtime.ts](/Users/ms/.codex/worktrees/1109/RPG_TG/src/core/runtime/playable-runtime.ts) so the remaining interactive helper types and fallback integration/owner-context helpers now model only `story-battle`; the obsolete `city-begging` interactive compatibility branch has been removed.
- Added [tests/interactive-runtime-residue.test.cjs](/Users/ms/.codex/worktrees/1109/RPG_TG/tests/interactive-runtime-residue.test.cjs) to guard that `playable-runtime` no longer carries `city-begging` interactive helper residue while `interactive-runtime` itself stays narrowed to `story-battle`.
