...
export type TavernHouseContentDefaults = {
  tavernBossProfile: TavernBossProfile;
...
const FALLBACK_TAVERN_HOUSE_CONTENT: TavernHouseContentDefaults = {
  tavernBossGreetingTextIds: ["runtime.zhu_yuanzhang.tavern.greeting.001"],
  ...
  tavernDefaultWager: 100,
  tavernDrinkPrice: 100,
  tavernWagerStep: 50,
  tavernWorkOffers: [
    {
...
export function getTavernHouseContentDefaults(): TavernHouseContentDefaults {
  return (
    getHouseModuleDefaults<TavernHouseContentDefaults>(
      defaultRuntimeContent.houseModuleDefaults,
      "tavern"
    ) ?? FALLBACK_TAVERN_HOUSE_CONTENT
  );
}
