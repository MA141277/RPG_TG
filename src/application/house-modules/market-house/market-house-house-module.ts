...
import {
  getMarketHouseCityDefinition,
  getMarketHouseContentDefaults,
  getMarketHouseTextEntries,
} from "./market-house-active-content";
...
function getCityDefinition(cityId: string): CityDefinition {
  return getMarketHouseCityDefinition(cityId);
}
...
function getMarketTextEntries(
  ...
  return getMarketHouseTextEntries({ textEntriesById });
}
