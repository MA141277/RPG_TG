...
export function ensurePlayerGrainInventory(state: GameState): GameState {
  const currentQuantityDou =
    state.runtime.variables[PLAYER_GRAIN_RUNTIME_KEYS.quantityDou];
