...
function renderAlertOverlay(overlay: Extract<HouseOverlayViewModel, { type: "alert" }>): string {
  return `
...
function renderTradeOverlay(overlay: Extract<HouseOverlayViewModel, { type: "trade" }>): string {
  return `
...
function renderMinigameOverlay(overlay: Extract<HouseOverlayViewModel, { type: "minigame" }>): string {
  return `
...
function renderResultOverlay(overlay: Extract<HouseOverlayViewModel, { type: "result" }>): string {
  return `
...
function renderActionContainer(viewModel: HouseModuleViewModel): string {
...
function renderStandbyRoster(viewModel: HouseModuleViewModel): string {
...
function renderDialogue(viewModel: HouseModuleViewModel): string {
...
function renderStatusCard(viewModel: HouseModuleViewModel): string {
