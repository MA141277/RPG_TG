...
type MedicineCompoundingHerbViewModel = MedicineCompoundingOverlayViewModel["herbs"][number];
    ...
    .map((herb, index) => {
      ...
      return `
        <button
          ...
          draggable="true"
          data-medicine-herb-action="${herb.actionId}"
          data-medicine-herb-id="${herb.id}"
          aria-label="拖拽 ${herb.name} 到药盘"
        >
        ...
        <section class="c-medicine-house-scene">
          ...
          <div class="c-medicine-house-scene__cauldron">
            <div class="c-medicine-house-cauldron">
              <span class="c-medicine-house-cauldron__hint">拖入药材至药盘</span>
              <div
                class="c-medicine-house-cauldron__dropzone"
                data-medicine-dropzone="compounding-cauldron"
                aria-label="药盘投放区"
              >
                ${
                  selectedHerbs.length === 0
                    ? '<p class="c-medicine-house-cauldron__empty">拖拽药材到此处</p>'
