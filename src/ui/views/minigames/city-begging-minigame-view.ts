...
const BEGGING_VILLAGE_ITEM_ASSETS = {
  monk: new URL(
    "../../../../化缘UI/material-202606031551-015.png",
    import.meta.url
  ).href,
  comboToast: new URL(
    "../../../../化缘UI/material-202606031551-010.png",
    import.meta.url
  ).href,
  riceBag: [
    new URL(
      "../../../../化缘UI/material-202606031551-019.png",
      import.meta.url
    ).href,
    new URL(
      "../../../../化缘UI/material-202606031551-020.png",
      import.meta.url
    ).href,
  ],
  steamedBun: [
    new URL(
      "../../../../化缘UI/material-202606031551-023.png",
      import.meta.url
    ).href,
    new URL(
      "../../../../化缘UI/material-202606031551-024.png",
      import.meta.url
    ).href,
  ],
  coin: new URL(
    "../../../../化缘UI/material-202606031551-026.png",
    import.meta.url
  ).href,
  rat: [
    new URL(
      "../../../../化缘UI/material-202606031551-025.png",
      import.meta.url
    ).href,
    new URL(
      "../../../../化缘UI/material-202606031551-027.png",
      import.meta.url
    ).href,
    new URL(
      "../../../../化缘UI/material-202606031551-029.png",
      import.meta.url
    ).href,
  ],
  brokenBowl: new URL(
    "../../../../化缘UI/material-202606031551-028.png",
    import.meta.url
  ).href,
  beam: [
    new URL(
      "../../../../化缘UI/material-202606031551-033.png",
      import.meta.url
    ).href,
    new URL(
      "../../../../化缘UI/material-202606031551-050.png",
      import.meta.url
    ).href,
    new URL(
      "../../../../化缘UI/material-202606031551-051.png",
      import.meta.url
    ).href,
    new URL(
      "../../../../化缘UI/material-202606031551-052.png",
      import.meta.url
    ).href,
  ],
} as const;
...
function renderGranaryEscortOverlay(state: CityBeggingMiniGameState): string {
  ...
  return `
    <div class="c-begging-game" role="dialog" aria-modal="true" aria-label="化缘小游戏">
      <div class="c-begging-game__veil"></div>
      <div class="c-begging-game__panel">
...
function renderVillageCatchingOverlay(state: CityBeggingMiniGameState): string {
  ...
  const eventActive = state.variantState.benevolenceRemainingMs > 0;
    ...
    <div class="c-begging-game c-begging-game--village" role="dialog" aria-modal="true" aria-label="化缘小游戏">
      ...
      <div class="c-begging-game__panel c-begging-game__panel--village">
        <div class="c-begging-game__village-stage">
          ...
          <aside class="c-begging-game__village-sidebar c-begging-game__village-sidebar--left" aria-label="化缘状态">
            ...
            <section class="c-begging-game__village-card c-begging-game__village-card--combo">
              ...
              >${state.variantState.combo}</strong>
            ...
            <section class="c-begging-game__village-card c-begging-game__village-card--food">
              ...
              >${formatVillageFoodLabel(state.variantState.previewFoodGain)}</strong>
            </section>
          </aside>
          <aside class="c-begging-game__village-sidebar c-begging-game__village-sidebar--right" aria-label="化缘事件">
            ...
            >
              ...
              <strong class="c-begging-game__village-event-time" data-begging-game-event-time>${eventActive ? `${formatSecondsLabel(
                state.variantState.benevolenceRemainingMs
              )}秒` : "--秒"}</strong>
            </section>
          </aside>
