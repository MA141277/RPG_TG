...
function renderCityMapScene(input: {
  ...
  const visibleBuildings = getVisibleCityMapBuildings({
    houseDefinitions: input.houseDefinitions,
    cityEntries: input.cityEntries,
  });

  warnForOverlappingCityMapBuildings(visibleBuildings);
  warnForCityMapDecorativeItems(
    CITY_MAP_DECOR_HOUSE_ITEMS,
    CITY_MAP_GROUND_DECOR_ITEMS,
    visibleBuildings
  );
    ...
    <div class="c-city-map-scene" aria-label="${input.cityDefinition.name}等距城镇地图">
      ...
      <div class="c-city-map-stage">
        <div
          ...
          style="--base-space-left:${formatStagePercent(CITY_MAP_BASE_LEFT_PERCENT)}; --base-space-top:${formatStagePercent(CITY_MAP_BASE_TOP_PERCENT)}; --base-space-width:${formatStagePercent(CITY_MAP_BASE_WIDTH_PERCENT)}; --base-space-height:${formatStagePercent(CITY_MAP_BASE_HEIGHT_PERCENT)};"
        >
          <img
          ...
          <div class="c-city-map-stage__ground-decorations">
            ${renderCityMapGroundDecorations(CITY_MAP_GROUND_DECOR_ITEMS)}
          </div>
          <div class="c-city-map-stage__visual-items">
            ${renderCityMapVisualItems({
              decorHouseItems: CITY_MAP_DECOR_HOUSE_ITEMS,
        ...
        <div
          ...
          style="--base-space-left:${formatStagePercent(CITY_MAP_BASE_LEFT_PERCENT)}; --base-space-top:${formatStagePercent(CITY_MAP_BASE_TOP_PERCENT)}; --base-space-width:${formatStagePercent(CITY_MAP_BASE_WIDTH_PERCENT)}; --base-space-height:${formatStagePercent(CITY_MAP_BASE_HEIGHT_PERCENT)};"
        >
          ${renderCityMapBuildingLabels(visibleBuildings)}
        </div>
      </div>
    </div>
  `;
