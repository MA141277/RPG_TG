...
type AnimationStepId = number | ReturnType<typeof globalThis.setTimeout>;
type TimeoutId = ReturnType<typeof globalThis.setTimeout>;

function requestAnimationStep(callback: FrameRequestCallback): AnimationStepId {
...
function cancelAnimationStep(frameId: AnimationStepId): void {
...
export function createCoinRewardAnimator(input: {
  ...
  let scheduledTimeouts: TimeoutId[] = [];
  let scheduledFrame: AnimationStepId | null = null;
